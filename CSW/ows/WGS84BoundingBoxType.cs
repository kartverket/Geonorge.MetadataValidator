...
{
	/// <summary>
	/// 	This class represents the ComplexType WGS84BoundingBoxType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"WGS84BoundingBoxType", "http://www.opengis.net/ows", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class WGS84BoundingBoxType : CSW.XmlCommonBase
					, ows.IBoundingBoxType
	{
		#region Constructors
		/// <summary>
		///		Constructor for WGS84BoundingBoxType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "WGS84BoundingBoxType";
			Init();
		}
		public WGS84BoundingBoxType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ows.WGS84BoundingBoxType newObject = new ows.WGS84BoundingBoxType(_elementName);
