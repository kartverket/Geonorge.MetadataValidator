...
{
	/// <summary>
	/// 	This class represents the ComplexType RequestMethodType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"RequestMethodType", "http://www.opengis.net/ows", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class RequestMethodType : CSW.XmlCommonBase
					, ows.IOnlineResourceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for RequestMethodType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "RequestMethodType";
			Init();
		}
		public RequestMethodType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ows.RequestMethodType newObject = new ows.RequestMethodType(_elementName);
