...
{
	/// <summary>
	/// 	This class represents the Element WGS84BoundingBox
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"WGS84BoundingBox", "http://www.opengis.net/ows", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class WGS84BoundingBox : CSW.XmlCommonBase
					, ows.IBoundingBoxType
	{
		#region Constructors
		/// <summary>
		///		Constructor for WGS84BoundingBox
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "WGS84BoundingBox";
			Init();
		}
		public WGS84BoundingBox(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ows.WGS84BoundingBox newObject = new ows.WGS84BoundingBox(_elementName);
