...
namespace ows
{
	...
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"Metadata", "http://www.opengis.net/ows", true, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class Metadata : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ows.Metadata newObject = new ows.Metadata(_elementName);
			...
			newObject.m_AbstractMetaData = null;
			if (m_AbstractMetaData != null)
				newObject.m_AbstractMetaData = (LiquidTechnologies.Runtime.Net45.Element)m_AbstractMetaData.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - AbstractMetaData
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqUntpdOpt("AbstractMetaData", "http://www.opengis.net/ows", "##any", "http://www.opengis.net/cat/csw/2.0.2")]
		public LiquidTechnologies.Runtime.Net45.Element AbstractMetaData
		{
			get
			{
				return m_AbstractMetaData;  
			}
			set
			{
				if (value != null)
					LiquidTechnologies.Runtime.Net45.Element.TestNamespace(value.Namespace, "##any", "http://www.opengis.net/cat/csw/2.0.2");
				m_AbstractMetaData = value; 
			}
		}
		protected LiquidTechnologies.Runtime.Net45.Element m_AbstractMetaData;
		#endregion
