...
{
	/// <summary>
	/// 	This class represents the Element PointOfContact
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PointOfContact", "http://www.opengis.net/ows", true, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PointOfContact : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for PointOfContact
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PointOfContact";
			Init();
		}
		public PointOfContact(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_OrganisationName = "";
			m_IsValidOrganisationName = false; 
			m_PositionName = "";
			m_IsValidPositionName = false; 
			m_ContactInfo = null;
			m_Role = new ows.Role("Role");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ows.PointOfContact newObject = new ows.PointOfContact(_elementName);
			newObject.m_IndividualName = m_IndividualName;
			newObject.m_IsValidIndividualName = m_IsValidIndividualName;
			newObject.m_OrganisationName = m_OrganisationName;
			newObject.m_IsValidOrganisationName = m_IsValidOrganisationName;
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - OrganisationName
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		/// 	<BR>It is optional, initially it is not valid.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimOpt("OrganisationName", "http://www.opengis.net/ows", "IsValidOrganisationName", null, LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Preserve, "", -1, -1, "", "", "", "", -1)]
		public String OrganisationName
		{
			get 
			{ 
				if (m_IsValidOrganisationName == false)
					throw new LiquidTechnologies.Runtime.Net45.LtInvalidStateException("The Property OrganisationName is not valid. Set OrganisationNameValid = true");
			...
			{ 
				// Apply whitespace rules appropriately
				value = LiquidTechnologies.Runtime.Net45.WhitespaceUtils.Preserve(value); 
				m_IsValidOrganisationName = true;
				m_OrganisationName = value;
			}
		}
		/// <summary>
		/// 	Indicates if OrganisationName contains a valid value.
		/// </summary>
		/// <remarks>
		/// 	<BR>true if the value for OrganisationName is valid, false if not.</BR>
		///		<BR>If this is set to true then the property is considered valid, and assigned its
		///		default value ("").</BR>
		///		<BR>If its set to false then its made invalid, and subsequent calls to get OrganisationName
		///		will raise an exception.</BR>
		/// </remarks>
		public Boolean IsValidOrganisationName
		{
			get
			{
				return m_IsValidOrganisationName;
			}
			set 
			{ 
				if (value != m_IsValidOrganisationName)
				{
					OrganisationName = "";
					m_IsValidOrganisationName = value;
				}
			}
		}
		protected Boolean m_IsValidOrganisationName;
		protected String m_OrganisationName;
		#endregion
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("Role", "http://www.opengis.net/ows", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(ows.Role), false)]
		public ows.Role Role
		{
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "Role");
				m_Role = value;
			}
		}
