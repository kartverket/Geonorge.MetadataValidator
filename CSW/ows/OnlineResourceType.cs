...
{
	/// <summary>
	/// 	This class represents the ComplexType OnlineResourceType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"OnlineResourceType", "http://www.opengis.net/ows", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class OnlineResourceType : CSW.XmlCommonBase
					, ows.IOnlineResourceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for OnlineResourceType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "OnlineResourceType";
			Init();
		}
		public OnlineResourceType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ows.OnlineResourceType newObject = new ows.OnlineResourceType(_elementName);
