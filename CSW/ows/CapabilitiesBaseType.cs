...
{
	/// <summary>
	/// 	This class represents the ComplexType CapabilitiesBaseType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CapabilitiesBaseType", "http://www.opengis.net/ows", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CapabilitiesBaseType : CSW.XmlCommonBase
					, ows.ICapabilitiesBaseType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CapabilitiesBaseType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CapabilitiesBaseType";
			Init();
		}
		public CapabilitiesBaseType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ows.CapabilitiesBaseType newObject = new ows.CapabilitiesBaseType(_elementName);
