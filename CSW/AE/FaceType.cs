...
{
	/// <summary>
	/// 	This class represents the ComplexType FaceType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"FaceType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class FaceType : CSW.XmlCommonBase
					, AE.IAbstractTopoPrimitiveType
	{
		#region Constructors
		/// <summary>
		///		Constructor for FaceType
		/// </summary>
		/// <remarks>
		...
		public FaceType()
		{
			_elementName = "FaceType";
			Init();
		}
		public FaceType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_DirectedTopoSolidCol = new CSW.XmlObjectCollection<AE.DirectedTopoSolid>("directedTopoSolid", "http://www.opengis.net/gml", 0, 2, false);
			m_SurfaceProperty = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.FaceType newObject = new AE.FaceType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.DirectedTopoSolid o in m_DirectedTopoSolidCol)
				newObject.m_DirectedTopoSolidCol.Add((AE.DirectedTopoSolid)o.Clone());
			newObject.m_SurfaceProperty = null;
			if (m_SurfaceProperty != null)
				newObject.m_SurfaceProperty = (AE.SurfaceProperty)m_SurfaceProperty.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - directedTopoSolid
		/// <summary>
		/// 	A collection of directedTopoSolidCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		/// 	<BR>This property is represented as an Element in the XML.</BR>
		/// 	<BR>This collection may contain 0 to 2 objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("directedTopoSolid", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.DirectedTopoSolid> DirectedTopoSolidCol
		{
			get { return m_DirectedTopoSolidCol; }
		}
		protected CSW.XmlObjectCollection<AE.DirectedTopoSolid> m_DirectedTopoSolidCol;
		
		#endregion

		#region Attribute - surfaceProperty
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("surfaceProperty", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.SurfaceProperty))]
		public AE.SurfaceProperty SurfaceProperty
		{
			get 
			{ 
			...
			{ 
				...
				{
					m_SurfaceProperty = value; 
				}
			}
		}
		protected AE.SurfaceProperty m_SurfaceProperty;
