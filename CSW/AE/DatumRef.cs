...
{
	/// <summary>
	/// 	This class represents the Element datumRef
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"datumRef", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DatumRef : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for DatumRef
		/// </summary>
		/// <remarks>
		...
		public DatumRef()
		{
			_elementName = "datumRef";
			Init();
		}
		public DatumRef(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DatumRef newObject = new AE.DatumRef(_elementName);
			...
			newObject.m_DatumRef_Group = null;
			if (m_DatumRef_Group != null)
				newObject.m_DatumRef_Group = (AE.DatumRef_Group)m_DatumRef_Group.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - datumRef_Group
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("datumRef_Group", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.DatumRef_Group))]
		public AE.DatumRef_Group DatumRef_Group
		{
			get 
			{ 
				return m_DatumRef_Group;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_DatumRef_Group = value; 
				}
			}
		}
		protected AE.DatumRef_Group m_DatumRef_Group;
