...
{
	/// <summary>
	/// 	This class represents the Element coordinateOperationName
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"coordinateOperationName", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class CoordinateOperationName : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CoordinateOperationName
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public CoordinateOperationName()
		{
			_elementName = "coordinateOperationName";
			Init();
		}
		public CoordinateOperationName(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CoordinateOperationName newObject = new AE.CoordinateOperationName(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element CoordinateOperationName, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;CoordinateOperationName&gt;Some Data&lt;/CoordinateOperationName&gt;</BR>
		/// </remarks>
