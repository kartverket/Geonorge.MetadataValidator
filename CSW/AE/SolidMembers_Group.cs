...
{
	/// <summary>
	/// 	This class represents the Element solidMembers_Group
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"solidMembers_Group", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class SolidMembers_Group : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for SolidMembers_Group
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public SolidMembers_Group()
		{
			_elementName = "solidMembers_Group";
			Init();
		}
		public SolidMembers_Group(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.SolidMembers_Group newObject = new AE.SolidMembers_Group(_elementName);
