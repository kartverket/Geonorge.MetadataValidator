...
{
	/// <summary>
	/// 	This class represents the Element polarCSRef
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"polarCSRef", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PolarCSRef : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for PolarCSRef
		/// </summary>
		/// <remarks>
		...
		public PolarCSRef()
		{
			_elementName = "polarCSRef";
			Init();
		}
		public PolarCSRef(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.PolarCSRef newObject = new AE.PolarCSRef(_elementName);
			...
			newObject.m_PolarCSRef_Group = null;
			if (m_PolarCSRef_Group != null)
				newObject.m_PolarCSRef_Group = (AE.PolarCSRef_Group)m_PolarCSRef_Group.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - polarCSRef_Group
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("polarCSRef_Group", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.PolarCSRef_Group))]
		public AE.PolarCSRef_Group PolarCSRef_Group
		{
			get 
			{ 
				return m_PolarCSRef_Group;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_PolarCSRef_Group = value; 
				}
			}
		}
		protected AE.PolarCSRef_Group m_PolarCSRef_Group;
