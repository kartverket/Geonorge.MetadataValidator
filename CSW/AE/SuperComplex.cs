...
{
	/// <summary>
	/// 	This class represents the Element superComplex
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"superComplex", "http://www.opengis.net/gml", true, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class SuperComplex : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for SuperComplex
		/// </summary>
		/// <remarks>
		...
		public SuperComplex()
		{
			_elementName = "superComplex";
			Init();
		}
		public SuperComplex(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.SuperComplex newObject = new AE.SuperComplex(_elementName);
