...
{
	/// <summary>
	/// 	This class represents the Element ValueArray
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ValueArray", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ValueArray : CSW.XmlCommonBase
					, AE.ICompositeValueType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ValueArray
		/// </summary>
		/// <remarks>
		...
		public ValueArray()
		{
			_elementName = "ValueArray";
			Init();
		}
		public ValueArray(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ValueArray newObject = new AE.ValueArray(_elementName);
			newObject.m_Id = m_Id;
