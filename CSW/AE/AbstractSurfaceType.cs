...
{
	/// <summary>
	/// 	This class represents the ComplexType AbstractSurfaceType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"AbstractSurfaceType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class AbstractSurfaceType : CSW.XmlCommonBase
					, AE.IAbstractSurfaceType
					, AE.IAbstractGeometricPrimitiveType
	{
		#region Constructors
		/// <summary>
		///		Constructor for AbstractSurfaceType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "AbstractSurfaceType";
			Init();
		}
		public AbstractSurfaceType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.AbstractSurfaceType newObject = new AE.AbstractSurfaceType(_elementName);
			newObject.m_Id = m_Id;
