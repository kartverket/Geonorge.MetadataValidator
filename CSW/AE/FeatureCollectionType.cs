...
{
	/// <summary>
	/// 	This class represents the ComplexType FeatureCollectionType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"FeatureCollectionType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class FeatureCollectionType : CSW.XmlCommonBase
					, AE.IFeatureCollectionType
					, AE.IAbstractFeatureCollectionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for FeatureCollectionType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "FeatureCollectionType";
			Init();
		}
		public FeatureCollectionType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.FeatureCollectionType newObject = new AE.FeatureCollectionType(_elementName);
			newObject.m_Id = m_Id;
