...
{
	/// <summary>
	/// 	This class represents the Element GenericMetaData
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GenericMetaData", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class GenericMetaData : CSW.XmlCommonBase
					, AE.IAbstractMetaDataType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GenericMetaData
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "GenericMetaData";
			Init();
		}
		public GenericMetaData(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.GenericMetaData newObject = new AE.GenericMetaData(_elementName);
			newObject.m_Id = m_Id;
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element GenericMetaData, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;GenericMetaData&gt;Some Data&lt;/GenericMetaData&gt;</BR>
		/// </remarks>
