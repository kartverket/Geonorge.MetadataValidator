...
{
	/// <summary>
	/// 	This class represents the Element MultiSurface
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiSurface", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiSurface : CSW.XmlCommonBase
					, AE.IAbstractGeometricAggregateType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiSurface
		/// </summary>
		/// <remarks>
		...
		public MultiSurface()
		{
			_elementName = "MultiSurface";
			Init();
		}
		public MultiSurface(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiSurface newObject = new AE.MultiSurface(_elementName);
			newObject.m_Id = m_Id;
