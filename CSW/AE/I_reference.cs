...
{
	/// <summary>
	/// 	This class represents the abstract Element I_reference
	/// </summary>
	/// <remarks>
	/// </remarks>
	public interface I_reference : LiquidTechnologies.Runtime.Net45.XmlObjectInterface
	{
