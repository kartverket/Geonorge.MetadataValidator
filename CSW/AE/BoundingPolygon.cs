...
{
	/// <summary>
	/// 	This class represents the Element boundingPolygon
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"boundingPolygon", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class BoundingPolygon : CSW.XmlCommonBase
					, AE.IAbstractSurfaceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for BoundingPolygon
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "boundingPolygon";
			Init();
		}
		public BoundingPolygon(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.BoundingPolygon newObject = new AE.BoundingPolygon(_elementName);
			newObject.m_Id = m_Id;
