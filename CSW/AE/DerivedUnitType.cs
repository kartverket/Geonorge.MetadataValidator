...
{
	/// <summary>
	/// 	This class represents the ComplexType DerivedUnitType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DerivedUnitType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DerivedUnitType : CSW.XmlCommonBase
					, AE.IUnitDefinitionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DerivedUnitType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DerivedUnitType";
			Init();
		}
		public DerivedUnitType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_DerivationUnitTermCol = new CSW.XmlObjectCollection<AE.DerivationUnitTerm>("derivationUnitTerm", "http://www.opengis.net/gml", 1, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DerivedUnitType newObject = new AE.DerivedUnitType(_elementName);
			newObject.m_Id = m_Id;
