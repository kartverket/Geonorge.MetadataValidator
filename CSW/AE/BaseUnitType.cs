...
{
	/// <summary>
	/// 	This class represents the ComplexType BaseUnitType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"BaseUnitType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class BaseUnitType : CSW.XmlCommonBase
					, AE.IUnitDefinitionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for BaseUnitType
		/// </summary>
		/// <remarks>
		...
		public BaseUnitType()
		{
			_elementName = "BaseUnitType";
			Init();
		}
		public BaseUnitType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_UnitsSystem = new AE.ReferenceType("unitsSystem");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.BaseUnitType newObject = new AE.BaseUnitType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_UnitsSystem = null;
			if (m_UnitsSystem != null)
				newObject.m_UnitsSystem = (AE.ReferenceType)m_UnitsSystem.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		///		<BR>If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("unitsSystem", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.ReferenceType), false)]
		public AE.ReferenceType UnitsSystem
		{
			get 
			{ 
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "unitsSystem");
				if (value != null)
					SetElementName(value, "unitsSystem");
				m_UnitsSystem = value;
			}
		}
		protected AE.ReferenceType m_UnitsSystem;
