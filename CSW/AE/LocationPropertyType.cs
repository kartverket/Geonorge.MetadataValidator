...
{
	/// <summary>
	/// 	This class represents the ComplexType LocationPropertyType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"LocationPropertyType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class LocationPropertyType : CSW.XmlCommonBase
					, AE.ILocationPropertyType
	{
		#region Constructors
		/// <summary>
		///		Constructor for LocationPropertyType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "LocationPropertyType";
			Init();
		}
		public LocationPropertyType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.LocationPropertyType newObject = new AE.LocationPropertyType(_elementName);
