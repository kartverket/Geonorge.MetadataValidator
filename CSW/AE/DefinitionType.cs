...
{
	/// <summary>
	/// 	This class represents the ComplexType DefinitionType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DefinitionType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DefinitionType : CSW.XmlCommonBase
					, AE.IDefinitionType
					, AE.IAbstractGMLType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DefinitionType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DefinitionType";
			Init();
		}
		public DefinitionType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DefinitionType newObject = new AE.DefinitionType(_elementName);
			newObject.m_Id = m_Id;
