...
{
	/// <summary>
	/// 	This class represents the Element PolygonPatch
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PolygonPatch", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PolygonPatch : CSW.XmlCommonBase
					, AE.IAbstractSurfacePatchType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PolygonPatch
		/// </summary>
		/// <remarks>
		...
		public PolygonPatch()
		{
			_elementName = "PolygonPatch";
			Init();
		}
		public PolygonPatch(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.PolygonPatch newObject = new AE.PolygonPatch(_elementName);
