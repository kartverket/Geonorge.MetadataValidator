...
{
	/// <summary>
	/// 	This class represents the ComplexType MultiSurfaceCoverageType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiSurfaceCoverageType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiSurfaceCoverageType : CSW.XmlCommonBase
					, AE.IAbstractDiscreteCoverageType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiSurfaceCoverageType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "MultiSurfaceCoverageType";
			Init();
		}
		public MultiSurfaceCoverageType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiSurfaceCoverageType newObject = new AE.MultiSurfaceCoverageType(_elementName);
			newObject.m_Id = m_Id;
