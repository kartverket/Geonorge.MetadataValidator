...
{
	/// <summary>
	/// 	This class represents the Element CoordinateSystemAxis
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CoordinateSystemAxis", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CoordinateSystemAxis : CSW.XmlCommonBase
					, AE.ICoordinateSystemAxisBaseType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CoordinateSystemAxis
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CoordinateSystemAxis";
			Init();
		}
		public CoordinateSystemAxis(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CoordinateSystemAxis newObject = new AE.CoordinateSystemAxis(_elementName);
			newObject.m_Id = m_Id;
