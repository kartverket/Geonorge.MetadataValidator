...
{
	/// <summary>
	/// 	This class represents the ComplexType ValueArrayType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ValueArrayType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ValueArrayType : CSW.XmlCommonBase
					, AE.ICompositeValueType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ValueArrayType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "ValueArrayType";
			Init();
		}
		public ValueArrayType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ValueArrayType newObject = new AE.ValueArrayType(_elementName);
			newObject.m_Id = m_Id;
