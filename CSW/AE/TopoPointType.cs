...
{
	/// <summary>
	/// 	This class represents the ComplexType TopoPointType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TopoPointType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TopoPointType : CSW.XmlCommonBase
					, AE.IAbstractTopologyType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TopoPointType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TopoPointType";
			Init();
		}
		public TopoPointType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_DirectedNode = new AE.DirectedNode("directedNode");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TopoPointType newObject = new AE.TopoPointType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_DirectedNode = null;
			if (m_DirectedNode != null)
				newObject.m_DirectedNode = (AE.DirectedNode)m_DirectedNode.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("directedNode", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.DirectedNode), false)]
		public AE.DirectedNode DirectedNode
		{
			get 
			{ 
				return m_DirectedNode;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "directedNode");
				m_DirectedNode = value;
			}
		}
		protected AE.DirectedNode m_DirectedNode;
