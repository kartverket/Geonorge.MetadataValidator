...
{
	/// <summary>
	/// 	This class represents the ComplexType GenericMetaDataType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GenericMetaDataType", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class GenericMetaDataType : CSW.XmlCommonBase
					, AE.IAbstractMetaDataType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GenericMetaDataType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "GenericMetaDataType";
			Init();
		}
		public GenericMetaDataType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.GenericMetaDataType newObject = new AE.GenericMetaDataType(_elementName);
			newObject.m_Id = m_Id;
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element GenericMetaDataType, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;GenericMetaDataType&gt;Some Data&lt;/GenericMetaDataType&gt;</BR>
		/// </remarks>
