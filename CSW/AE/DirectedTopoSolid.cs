...
{
	/// <summary>
	/// 	This class represents the Element directedTopoSolid
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"directedTopoSolid", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DirectedTopoSolid : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for DirectedTopoSolid
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "directedTopoSolid";
			Init();
		}
		public DirectedTopoSolid(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_Orientation = AE.Enumerations.SignType.Plus;
			m_IsValidOrientation = true;
			...
			m_DirectedTopoSolid_Group = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DirectedTopoSolid newObject = new AE.DirectedTopoSolid(_elementName);
			newObject.m_Orientation = m_Orientation;
			newObject.m_IsValidOrientation = m_IsValidOrientation;
			...
			newObject.m_DirectedTopoSolid_Group = null;
			if (m_DirectedTopoSolid_Group != null)
				newObject.m_DirectedTopoSolid_Group = (AE.DirectedTopoSolid_Group)m_DirectedTopoSolid_Group.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.AttributeInfoEnum("orientation", "", "IsValidOrientation", typeof(AE.Enumerations), "SignTypeFromString", "SignTypeToString", "+")]
		public AE.Enumerations.SignType Orientation
		{
			get 
			{ 
				if (m_IsValidOrientation == false)
					throw new LiquidTechnologies.Runtime.Net45.LtInvalidStateException("The Property orientation is not valid. Set orientationValid = true");
		...
		/// <summary>
		/// 	Indicates if orientation contains a valid value.
		/// </summary>
		/// <remarks>
		/// 	<BR>true if the value for orientation is valid, false if not.</BR>
		///		<BR>If this is set to true then the property is considered valid, and assigned its
		///		default value (AE.Enumerations.SignType.Plus).</BR>
		///		<BR>If its set to false then its made invalid, and subsequent calls to get orientation
		///		will raise an exception.</BR>
		/// </remarks>
		public Boolean IsValidOrientation
		{
			get { return m_IsValidOrientation;  }
			set 
			{ 
				if (value != m_IsValidOrientation)
				{
					Orientation = AE.Enumerations.SignType.Plus;
					m_IsValidOrientation = value;
				}
			}
		}
		protected AE.Enumerations.SignType m_Orientation;
		protected Boolean m_IsValidOrientation;
		...
		public String Arcrole
		{
			...
			set 
			{ 
				CheckAttributeRestriction(4, value);
				// Apply whitespace rules appropriately
				value = LiquidTechnologies.Runtime.Net45.WhitespaceUtils.Collapse(value); 
		...
		#region Attribute - directedTopoSolid_Group
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("directedTopoSolid_Group", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.DirectedTopoSolid_Group))]
		public AE.DirectedTopoSolid_Group DirectedTopoSolid_Group
		{
			get 
			{ 
				return m_DirectedTopoSolid_Group;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_DirectedTopoSolid_Group = value; 
				}
			}
		}
		protected AE.DirectedTopoSolid_Group m_DirectedTopoSolid_Group;
