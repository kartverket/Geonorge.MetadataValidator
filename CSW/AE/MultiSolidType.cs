...
{
	/// <summary>
	/// 	This class represents the ComplexType MultiSolidType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiSolidType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiSolidType : CSW.XmlCommonBase
					, AE.IAbstractGeometricAggregateType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiSolidType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "MultiSolidType";
			Init();
		}
		public MultiSolidType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_SolidMemberCol = new CSW.XmlObjectCollection<AE.SolidMember>("solidMember", "http://www.opengis.net/gml", 0, -1, false);
			m_SolidMembers = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiSolidType newObject = new AE.MultiSolidType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.SolidMember o in m_SolidMemberCol)
				newObject.m_SolidMemberCol.Add((AE.SolidMember)o.Clone());
			newObject.m_SolidMembers = null;
			if (m_SolidMembers != null)
				newObject.m_SolidMembers = (AE.SolidMembers)m_SolidMembers.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - solidMember
		/// <summary>
		/// 	A collection of solidMemberCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// 	<BR>This collection may contain 0 to Many objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("solidMember", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.SolidMember> SolidMemberCol
		{
			get { return m_SolidMemberCol; }
		}
		protected CSW.XmlObjectCollection<AE.SolidMember> m_SolidMemberCol;
		
		#endregion

		#region Attribute - solidMembers
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("solidMembers", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.SolidMembers))]
		public AE.SolidMembers SolidMembers
		{
			get 
			{ 
				return m_SolidMembers;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_SolidMembers = value; 
				}
			}
		}
		protected AE.SolidMembers m_SolidMembers;
