...
{
	/// <summary>
	/// 	This class represents the ComplexType MultiCurveType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiCurveType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiCurveType : CSW.XmlCommonBase
					, AE.IAbstractGeometricAggregateType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiCurveType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "MultiCurveType";
			Init();
		}
		public MultiCurveType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_CurveMemberCol = new CSW.XmlObjectCollection<AE.CurveMember>("curveMember", "http://www.opengis.net/gml", 0, -1, false);
			m_CurveMembers = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiCurveType newObject = new AE.MultiCurveType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.CurveMember o in m_CurveMemberCol)
				newObject.m_CurveMemberCol.Add((AE.CurveMember)o.Clone());
			newObject.m_CurveMembers = null;
			if (m_CurveMembers != null)
				newObject.m_CurveMembers = (AE.CurveMembers)m_CurveMembers.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - curveMember
		/// <summary>
		/// 	A collection of curveMemberCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// 	<BR>This collection may contain 0 to Many objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("curveMember", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.CurveMember> CurveMemberCol
		{
			get { return m_CurveMemberCol; }
		}
		protected CSW.XmlObjectCollection<AE.CurveMember> m_CurveMemberCol;
		
		#endregion

		#region Attribute - curveMembers
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("curveMembers", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.CurveMembers))]
		public AE.CurveMembers CurveMembers
		{
			get 
			{ 
				return m_CurveMembers;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_CurveMembers = value; 
				}
			}
		}
		protected AE.CurveMembers m_CurveMembers;
