...
{
	/// <summary>
	/// 	This class represents the ComplexType GridType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GridType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GridType : CSW.XmlCommonBase
					, AE.IGridType
					, AE.IAbstractGeometryType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GridType
		/// </summary>
		/// <remarks>
		...
		public GridType()
		{
			_elementName = "GridType";
			Init();
		}
		public GridType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.GridType newObject = new AE.GridType(_elementName);
			newObject.m_Id = m_Id;
