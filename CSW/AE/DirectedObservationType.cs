...
{
	/// <summary>
	/// 	This class represents the ComplexType DirectedObservationType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DirectedObservationType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DirectedObservationType : CSW.XmlCommonBase
					, AE.IDirectedObservationType
					, AE.IObservationType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DirectedObservationType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DirectedObservationType";
			Init();
		}
		public DirectedObservationType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DirectedObservationType newObject = new AE.DirectedObservationType(_elementName);
			newObject.m_Id = m_Id;
