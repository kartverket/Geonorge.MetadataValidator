...
{
	/// <summary>
	/// 	This class represents the Element CategoryExtent
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CategoryExtent", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class CategoryExtent : CSW.XmlCommonBase
					, AE.ICodeOrNullListType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CategoryExtent
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CategoryExtent";
			Init();
		}
		public CategoryExtent(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CategoryExtent newObject = new AE.CategoryExtent(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element CategoryExtent, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;CategoryExtent&gt;Some Data&lt;/CategoryExtent&gt;</BR>
		/// </remarks>
