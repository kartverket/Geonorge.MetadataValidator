...
{
	/// <summary>
	/// 	This class represents the ComplexType MovingObjectStatusType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MovingObjectStatusType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MovingObjectStatusType : CSW.XmlCommonBase
					, AE.IAbstractTimeSliceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MovingObjectStatusType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "MovingObjectStatusType";
			Init();
		}
		public MovingObjectStatusType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MovingObjectStatusType newObject = new AE.MovingObjectStatusType(_elementName);
			newObject.m_Id = m_Id;
