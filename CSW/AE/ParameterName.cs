...
{
	/// <summary>
	/// 	This class represents the Element parameterName
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"parameterName", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class ParameterName : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ParameterName
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "parameterName";
			Init();
		}
		public ParameterName(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ParameterName newObject = new AE.ParameterName(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element ParameterName, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;ParameterName&gt;Some Data&lt;/ParameterName&gt;</BR>
		/// </remarks>
