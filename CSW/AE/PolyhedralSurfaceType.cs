...
{
	/// <summary>
	/// 	This class represents the ComplexType PolyhedralSurfaceType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PolyhedralSurfaceType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PolyhedralSurfaceType : CSW.XmlCommonBase
					, AE.ISurfaceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PolyhedralSurfaceType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PolyhedralSurfaceType";
			Init();
		}
		public PolyhedralSurfaceType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.PolyhedralSurfaceType newObject = new AE.PolyhedralSurfaceType(_elementName);
			newObject.m_Id = m_Id;
