...
{
	/// <summary>
	/// 	This class represents the Element axisDirection
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"axisDirection", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class AxisDirection : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for AxisDirection
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "axisDirection";
			Init();
		}
		public AxisDirection(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.AxisDirection newObject = new AE.AxisDirection(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element AxisDirection, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;AxisDirection&gt;Some Data&lt;/AxisDirection&gt;</BR>
		/// </remarks>
