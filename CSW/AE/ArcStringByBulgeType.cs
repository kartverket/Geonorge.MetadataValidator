...
{
	/// <summary>
	/// 	This class represents the ComplexType ArcStringByBulgeType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ArcStringByBulgeType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ArcStringByBulgeType : CSW.XmlCommonBase
					, AE.IArcStringByBulgeType
					, AE.IAbstractCurveSegmentType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ArcStringByBulgeType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "ArcStringByBulgeType";
			Init();
		}
		public ArcStringByBulgeType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ArcStringByBulgeType newObject = new AE.ArcStringByBulgeType(_elementName);
