...
{
	/// <summary>
	/// 	This class represents the ComplexType TemporalCRSType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TemporalCRSType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TemporalCRSType : CSW.XmlCommonBase
					, AE.IAbstractReferenceSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TemporalCRSType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TemporalCRSType";
			Init();
		}
		public TemporalCRSType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_UsesTemporalCS = new AE.UsesTemporalCS("usesTemporalCS");
			m_UsesTemporalDatum = new AE.UsesTemporalDatum("usesTemporalDatum");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TemporalCRSType newObject = new AE.TemporalCRSType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_UsesTemporalCS = null;
			if (m_UsesTemporalCS != null)
				newObject.m_UsesTemporalCS = (AE.UsesTemporalCS)m_UsesTemporalCS.Clone();
			newObject.m_UsesTemporalDatum = null;
			if (m_UsesTemporalDatum != null)
				newObject.m_UsesTemporalDatum = (AE.UsesTemporalDatum)m_UsesTemporalDatum.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - usesTemporalCS
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("usesTemporalCS", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.UsesTemporalCS), false)]
		public AE.UsesTemporalCS UsesTemporalCS
		{
			get 
			{ 
				return m_UsesTemporalCS;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "usesTemporalCS");
				m_UsesTemporalCS = value;
			}
		}
		protected AE.UsesTemporalCS m_UsesTemporalCS;
		
		#endregion

		#region Attribute - usesTemporalDatum
		/// <summary>
		///		Represents a mandatory Element in the XML document
		/// 	
		/// </summary>
		...
		///		<BR>If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("usesTemporalDatum", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.UsesTemporalDatum), false)]
		public AE.UsesTemporalDatum UsesTemporalDatum
		{
			get 
			{ 
				return m_UsesTemporalDatum;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "usesTemporalDatum");
				m_UsesTemporalDatum = value;
			}
		}
		protected AE.UsesTemporalDatum m_UsesTemporalDatum;
