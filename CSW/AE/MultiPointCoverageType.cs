...
{
	/// <summary>
	/// 	This class represents the ComplexType MultiPointCoverageType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiPointCoverageType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiPointCoverageType : CSW.XmlCommonBase
					, AE.IAbstractDiscreteCoverageType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiPointCoverageType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "MultiPointCoverageType";
			Init();
		}
		public MultiPointCoverageType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiPointCoverageType newObject = new AE.MultiPointCoverageType(_elementName);
			newObject.m_Id = m_Id;
