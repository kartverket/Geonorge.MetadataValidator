...
{
	/// <summary>
	/// 	This class represents the Element operationMethodRef
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"operationMethodRef", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class OperationMethodRef : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for OperationMethodRef
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public OperationMethodRef()
		{
			_elementName = "operationMethodRef";
			Init();
		}
		public OperationMethodRef(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_OperationMethodRef_Group = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.OperationMethodRef newObject = new AE.OperationMethodRef(_elementName);
			...
			newObject.m_OperationMethodRef_Group = null;
			if (m_OperationMethodRef_Group != null)
				newObject.m_OperationMethodRef_Group = (AE.OperationMethodRef_Group)m_OperationMethodRef_Group.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - operationMethodRef_Group
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("operationMethodRef_Group", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.OperationMethodRef_Group))]
		public AE.OperationMethodRef_Group OperationMethodRef_Group
		{
			get 
			{ 
				return m_OperationMethodRef_Group;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_OperationMethodRef_Group = value; 
				}
			}
		}
		protected AE.OperationMethodRef_Group m_OperationMethodRef_Group;
