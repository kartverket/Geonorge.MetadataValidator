...
{
	/// <summary>
	/// 	This class represents the ComplexType TopoComplexType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TopoComplexType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TopoComplexType : CSW.XmlCommonBase
					, AE.IAbstractTopologyType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TopoComplexType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TopoComplexType";
			Init();
		}
		public TopoComplexType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TopoComplexType newObject = new AE.TopoComplexType(_elementName);
			newObject.m_Id = m_Id;
