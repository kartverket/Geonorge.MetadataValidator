...
{
	/// <summary>
	/// 	This class represents the ComplexType PolygonType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PolygonType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PolygonType : CSW.XmlCommonBase
					, AE.IAbstractSurfaceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PolygonType
		/// </summary>
		/// <remarks>
		...
		public PolygonType()
		{
			_elementName = "PolygonType";
			Init();
		}
		public PolygonType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.PolygonType newObject = new AE.PolygonType(_elementName);
			newObject.m_Id = m_Id;
