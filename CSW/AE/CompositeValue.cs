...
{
	/// <summary>
	/// 	This class represents the Element CompositeValue
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CompositeValue", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CompositeValue : CSW.XmlCommonBase
					, AE.IAbstractGMLType
					, AE.ICompositeValueType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CompositeValue
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CompositeValue";
			Init();
		}
		public CompositeValue(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CompositeValue newObject = new AE.CompositeValue(_elementName);
			newObject.m_Id = m_Id;
