...
{
	/// <summary>
	/// 	This class represents the ComplexType GeodesicStringType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GeodesicStringType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GeodesicStringType : CSW.XmlCommonBase
					, AE.IGeodesicStringType
					, AE.IAbstractCurveSegmentType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GeodesicStringType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "GeodesicStringType";
			Init();
		}
		public GeodesicStringType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.GeodesicStringType newObject = new AE.GeodesicStringType(_elementName);
