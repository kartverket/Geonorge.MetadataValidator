...
{
	/// <summary>
	/// 	This class represents the ComplexType VerticalDatumType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"VerticalDatumType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class VerticalDatumTypeA : CSW.XmlCommonBase
					, AE.IAbstractDatumType
	{
		#region Constructors
		/// <summary>
		///		Constructor for VerticalDatumTypeA
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public VerticalDatumTypeA()
		{
			_elementName = "VerticalDatumType";
			Init();
		}
		public VerticalDatumTypeA(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.VerticalDatumTypeA newObject = new AE.VerticalDatumTypeA(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_VerticalDatumType = null;
			if (m_VerticalDatumType != null)
				newObject.m_VerticalDatumType = (AE.VerticalDatumType)m_VerticalDatumType.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - verticalDatumType
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("verticalDatumType", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.VerticalDatumType))]
		public AE.VerticalDatumType VerticalDatumType
		{
			get 
			{ 
				return m_VerticalDatumType;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_VerticalDatumType = value; 
				}
			}
		}
		protected AE.VerticalDatumType m_VerticalDatumType;
