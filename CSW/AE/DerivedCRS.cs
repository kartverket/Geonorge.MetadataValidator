...
{
	/// <summary>
	/// 	This class represents the Element DerivedCRS
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DerivedCRS", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DerivedCRS : CSW.XmlCommonBase
					, AE.IAbstractGeneralDerivedCRSType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DerivedCRS
		/// </summary>
		/// <remarks>
		...
		public DerivedCRS()
		{
			_elementName = "DerivedCRS";
			Init();
		}
		public DerivedCRS(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DerivedCRS newObject = new AE.DerivedCRS(_elementName);
			newObject.m_Id = m_Id;
