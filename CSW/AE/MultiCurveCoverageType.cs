...
{
	/// <summary>
	/// 	This class represents the ComplexType MultiCurveCoverageType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiCurveCoverageType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiCurveCoverageType : CSW.XmlCommonBase
					, AE.IAbstractDiscreteCoverageType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiCurveCoverageType
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public MultiCurveCoverageType()
		{
			_elementName = "MultiCurveCoverageType";
			Init();
		}
		public MultiCurveCoverageType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiCurveCoverageType newObject = new AE.MultiCurveCoverageType(_elementName);
			newObject.m_Id = m_Id;
