...
{
	/// <summary>
	/// 	This class represents the Element DefinitionProxy
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DefinitionProxy", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DefinitionProxy : CSW.XmlCommonBase
					, AE.IDefinitionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DefinitionProxy
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DefinitionProxy";
			Init();
		}
		public DefinitionProxy(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DefinitionProxy newObject = new AE.DefinitionProxy(_elementName);
			newObject.m_Id = m_Id;
