...
{
	/// <summary>
	/// 	This class represents the Element result
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"result", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_r8, null, false)]
	public partial class Result : CSW.XmlCommonBase
					, AE.IMeasureType
	{
		#region Constructors
		/// <summary>
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.Result newObject = new AE.Result(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element Result, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;Result&gt;Some Data&lt;/Result&gt;</BR>
		/// </remarks>
