...
{
	/// <summary>
	/// 	This class represents the Element CompoundCRS
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CompoundCRS", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CompoundCRS : CSW.XmlCommonBase
					, AE.IAbstractReferenceSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CompoundCRS
		/// </summary>
		/// <remarks>
		...
		public CompoundCRS()
		{
			_elementName = "CompoundCRS";
			Init();
		}
		public CompoundCRS(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CompoundCRS newObject = new AE.CompoundCRS(_elementName);
			newObject.m_Id = m_Id;
