...
{
	/// <summary>
	/// 	This class represents the Element TriangulatedSurface
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TriangulatedSurface", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TriangulatedSurface : CSW.XmlCommonBase
					, AE.ISurfaceType
					, AE.ITriangulatedSurfaceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TriangulatedSurface
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TriangulatedSurface";
			Init();
		}
		public TriangulatedSurface(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TriangulatedSurface newObject = new AE.TriangulatedSurface(_elementName);
			newObject.m_Id = m_Id;
