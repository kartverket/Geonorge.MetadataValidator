...
{
	/// <summary>
	/// 	This class represents the ComplexType CompoundCRSType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CompoundCRSType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CompoundCRSType : CSW.XmlCommonBase
					, AE.IAbstractReferenceSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CompoundCRSType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CompoundCRSType";
			Init();
		}
		public CompoundCRSType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_IncludesCRSCol = new CSW.XmlObjectCollection<AE.IncludesCRS>("includesCRS", "http://www.opengis.net/gml", 2, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CompoundCRSType newObject = new AE.CompoundCRSType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.IncludesCRS o in m_IncludesCRSCol)
				newObject.m_IncludesCRSCol.Add((AE.IncludesCRS)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - includesCRS
		/// <summary>
		/// 	A collection of includesCRSCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("includesCRS", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.IncludesCRS> IncludesCRSCol
		{
			get { return m_IncludesCRSCol; }
		}
		protected CSW.XmlObjectCollection<AE.IncludesCRS> m_IncludesCRSCol;
