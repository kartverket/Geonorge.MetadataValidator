...
{
	/// <summary>
	/// 	This class represents the Element datumName
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"datumName", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class DatumName : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DatumName
		/// </summary>
		/// <remarks>
		...
		public DatumName()
		{
			_elementName = "datumName";
			Init();
		}
		public DatumName(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DatumName newObject = new AE.DatumName(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element DatumName, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;DatumName&gt;Some Data&lt;/DatumName&gt;</BR>
		/// </remarks>
