...
{
	/// <summary>
	/// 	This class represents the ComplexType VerticalCRSType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"VerticalCRSType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class VerticalCRSType : CSW.XmlCommonBase
					, AE.IAbstractReferenceSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for VerticalCRSType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "VerticalCRSType";
			Init();
		}
		public VerticalCRSType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_UsesVerticalCS = new AE.UsesVerticalCS("usesVerticalCS");
			m_UsesVerticalDatum = new AE.UsesVerticalDatum("usesVerticalDatum");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.VerticalCRSType newObject = new AE.VerticalCRSType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_UsesVerticalCS = null;
			if (m_UsesVerticalCS != null)
				newObject.m_UsesVerticalCS = (AE.UsesVerticalCS)m_UsesVerticalCS.Clone();
			newObject.m_UsesVerticalDatum = null;
			if (m_UsesVerticalDatum != null)
				newObject.m_UsesVerticalDatum = (AE.UsesVerticalDatum)m_UsesVerticalDatum.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - usesVerticalCS
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("usesVerticalCS", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.UsesVerticalCS), false)]
		public AE.UsesVerticalCS UsesVerticalCS
		{
			get 
			{ 
				return m_UsesVerticalCS;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "usesVerticalCS");
				m_UsesVerticalCS = value;
			}
		}
		protected AE.UsesVerticalCS m_UsesVerticalCS;
		
		#endregion

		#region Attribute - usesVerticalDatum
		/// <summary>
		///		Represents a mandatory Element in the XML document
		/// 	
		/// </summary>
		...
		///		<BR>If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("usesVerticalDatum", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.UsesVerticalDatum), false)]
		public AE.UsesVerticalDatum UsesVerticalDatum
		{
			get 
			{ 
				return m_UsesVerticalDatum;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "usesVerticalDatum");
				m_UsesVerticalDatum = value;
			}
		}
		protected AE.UsesVerticalDatum m_UsesVerticalDatum;
