...
{
	/// <summary>
	/// 	This class represents the Element GeodesicString
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GeodesicString", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GeodesicString : CSW.XmlCommonBase
					, AE.IAbstractCurveSegmentType
					, AE.IGeodesicStringType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GeodesicString
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "GeodesicString";
			Init();
		}
		public GeodesicString(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.GeodesicString newObject = new AE.GeodesicString(_elementName);
