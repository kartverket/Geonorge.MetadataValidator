...
{
	/// <summary>
	/// 	This class represents the ComplexType GeodeticDatumType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GeodeticDatumType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GeodeticDatumType : CSW.XmlCommonBase
					, AE.IAbstractDatumType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GeodeticDatumType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "GeodeticDatumType";
			Init();
		}
		public GeodeticDatumType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.GeodeticDatumType newObject = new AE.GeodeticDatumType(_elementName);
			newObject.m_Id = m_Id;
