...
{
	/// <summary>
	/// 	This class represents the Element usesOperation_Group
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"usesOperation_Group", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class UsesOperation_Group : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for UsesOperation_Group
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public UsesOperation_Group()
		{
			_elementName = "usesOperation_Group";
			Init();
		}
		public UsesOperation_Group(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.UsesOperation_Group newObject = new AE.UsesOperation_Group(_elementName);
