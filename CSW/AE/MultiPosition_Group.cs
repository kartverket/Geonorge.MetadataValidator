...
{
	/// <summary>
	/// 	This class represents the Element multiPosition_Group
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"multiPosition_Group", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiPosition_Group : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiPosition_Group
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public MultiPosition_Group()
		{
			_elementName = "multiPosition_Group";
			Init();
		}
		public MultiPosition_Group(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiPosition_Group newObject = new AE.MultiPosition_Group(_elementName);
