...
{
	/// <summary>
	/// 	This class represents the Element VerticalDatum
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"VerticalDatum", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class VerticalDatum : CSW.XmlCommonBase
					, AE.IAbstractDatumType
	{
		#region Constructors
		/// <summary>
		///		Constructor for VerticalDatum
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "VerticalDatum";
			Init();
		}
		public VerticalDatum(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.VerticalDatum newObject = new AE.VerticalDatum(_elementName);
			newObject.m_Id = m_Id;
