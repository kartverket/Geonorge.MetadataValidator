...
{
	/// <summary>
	/// 	This class represents the ComplexType BezierType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"BezierType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class BezierType : CSW.XmlCommonBase
					, AE.IBSplineType
	{
		#region Constructors
		/// <summary>
		///		Constructor for BezierType
		/// </summary>
		/// <remarks>
		...
		public BezierType()
		{
			_elementName = "BezierType";
			Init();
		}
		public BezierType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.BezierType newObject = new AE.BezierType(_elementName);
