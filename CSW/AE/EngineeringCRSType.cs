...
{
	/// <summary>
	/// 	This class represents the ComplexType EngineeringCRSType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"EngineeringCRSType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class EngineeringCRSType : CSW.XmlCommonBase
					, AE.IAbstractReferenceSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for EngineeringCRSType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "EngineeringCRSType";
			Init();
		}
		public EngineeringCRSType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_UsesEngineeringDatum = new AE.UsesEngineeringDatum("usesEngineeringDatum");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.EngineeringCRSType newObject = new AE.EngineeringCRSType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_UsesEngineeringDatum = null;
			if (m_UsesEngineeringDatum != null)
				newObject.m_UsesEngineeringDatum = (AE.UsesEngineeringDatum)m_UsesEngineeringDatum.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - usesEngineeringDatum
		/// <summary>
		///		Represents a mandatory Element in the XML document
		/// 	
		/// </summary>
		...
		///		<BR>If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("usesEngineeringDatum", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.UsesEngineeringDatum), false)]
		public AE.UsesEngineeringDatum UsesEngineeringDatum
		{
			get 
			{ 
				return m_UsesEngineeringDatum;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "usesEngineeringDatum");
				m_UsesEngineeringDatum = value;
			}
		}
		protected AE.UsesEngineeringDatum m_UsesEngineeringDatum;
