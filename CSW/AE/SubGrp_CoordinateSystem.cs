...
{
	/// <summary>
	/// 	This class represents the Element SubGrp_CoordinateSystem
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"SubGrp_CoordinateSystem", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class SubGrp_CoordinateSystem : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for SubGrp_CoordinateSystem
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public SubGrp_CoordinateSystem()
		{
			_elementName = "SubGrp_CoordinateSystem";
			Init();
		}
		public SubGrp_CoordinateSystem(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.SubGrp_CoordinateSystem newObject = new AE.SubGrp_CoordinateSystem(_elementName);
