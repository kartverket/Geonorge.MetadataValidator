...
{
	/// <summary>
	/// 	This class represents the Element EnvelopeWithTimePeriod
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"EnvelopeWithTimePeriod", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class EnvelopeWithTimePeriod : CSW.XmlCommonBase
					, AE.IEnvelopeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for EnvelopeWithTimePeriod
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "EnvelopeWithTimePeriod";
			Init();
		}
		public EnvelopeWithTimePeriod(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.EnvelopeWithTimePeriod newObject = new AE.EnvelopeWithTimePeriod(_elementName);
