...
{
	/// <summary>
	/// 	This class represents the ComplexType UserDefinedCSType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"UserDefinedCSType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class UserDefinedCSType : CSW.XmlCommonBase
					, AE.IAbstractCoordinateSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for UserDefinedCSType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "UserDefinedCSType";
			Init();
		}
		public UserDefinedCSType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.UserDefinedCSType newObject = new AE.UserDefinedCSType(_elementName);
			newObject.m_Id = m_Id;
