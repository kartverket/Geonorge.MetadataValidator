...
{
	/// <summary>
	/// 	This class represents the ComplexType PriorityLocationPropertyType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PriorityLocationPropertyType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PriorityLocationPropertyType : CSW.XmlCommonBase
					, AE.ILocationPropertyType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PriorityLocationPropertyType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PriorityLocationPropertyType";
			Init();
		}
		public PriorityLocationPropertyType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.PriorityLocationPropertyType newObject = new AE.PriorityLocationPropertyType(_elementName);
