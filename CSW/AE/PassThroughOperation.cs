...
{
	/// <summary>
	/// 	This class represents the Element PassThroughOperation
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PassThroughOperation", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PassThroughOperation : CSW.XmlCommonBase
					, AE.IAbstractCoordinateOperationType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PassThroughOperation
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PassThroughOperation";
			Init();
		}
		public PassThroughOperation(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.PassThroughOperation newObject = new AE.PassThroughOperation(_elementName);
			newObject.m_Id = m_Id;
