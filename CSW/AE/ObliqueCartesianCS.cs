...
{
	/// <summary>
	/// 	This class represents the Element ObliqueCartesianCS
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ObliqueCartesianCS", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ObliqueCartesianCS : CSW.XmlCommonBase
					, AE.IAbstractCoordinateSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ObliqueCartesianCS
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public ObliqueCartesianCS()
		{
			_elementName = "ObliqueCartesianCS";
			Init();
		}
		public ObliqueCartesianCS(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ObliqueCartesianCS newObject = new AE.ObliqueCartesianCS(_elementName);
			newObject.m_Id = m_Id;
