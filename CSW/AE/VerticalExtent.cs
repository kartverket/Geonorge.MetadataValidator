...
{
	/// <summary>
	/// 	This class represents the Element verticalExtent
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"verticalExtent", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class VerticalExtent : CSW.XmlCommonBase
					, AE.IEnvelopeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for VerticalExtent
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "verticalExtent";
			Init();
		}
		public VerticalExtent(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.VerticalExtent newObject = new AE.VerticalExtent(_elementName);
