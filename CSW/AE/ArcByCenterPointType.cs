...
{
	/// <summary>
	/// 	This class represents the ComplexType ArcByCenterPointType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ArcByCenterPointType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ArcByCenterPointType : CSW.XmlCommonBase
					, AE.IArcByCenterPointType
					, AE.IAbstractCurveSegmentType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ArcByCenterPointType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "ArcByCenterPointType";
			Init();
		}
		public ArcByCenterPointType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ArcByCenterPointType newObject = new AE.ArcByCenterPointType(_elementName);
