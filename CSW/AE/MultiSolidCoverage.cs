...
{
	/// <summary>
	/// 	This class represents the Element MultiSolidCoverage
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiSolidCoverage", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiSolidCoverage : CSW.XmlCommonBase
					, AE.IAbstractDiscreteCoverageType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiSolidCoverage
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "MultiSolidCoverage";
			Init();
		}
		public MultiSolidCoverage(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiSolidCoverage newObject = new AE.MultiSolidCoverage(_elementName);
			newObject.m_Id = m_Id;
