...
{
	/// <summary>
	/// 	This class represents the Element RectifiedGrid
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"RectifiedGrid", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class RectifiedGrid : CSW.XmlCommonBase
					, AE.IGridType
	{
		#region Constructors
		/// <summary>
		///		Constructor for RectifiedGrid
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "RectifiedGrid";
			Init();
		}
		public RectifiedGrid(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.RectifiedGrid newObject = new AE.RectifiedGrid(_elementName);
			newObject.m_Id = m_Id;
