...
{
	/// <summary>
	/// 	This class represents the Element SubGrp_ParametricCurveSurface
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"SubGrp_ParametricCurveSurface", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class SubGrp_ParametricCurveSurface : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for SubGrp_ParametricCurveSurface
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public SubGrp_ParametricCurveSurface()
		{
			_elementName = "SubGrp_ParametricCurveSurface";
			Init();
		}
		public SubGrp_ParametricCurveSurface(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.SubGrp_ParametricCurveSurface newObject = new AE.SubGrp_ParametricCurveSurface(_elementName);
			...
			newObject.m_SubGrp_GriddedSurface = null;
			if (m_SubGrp_GriddedSurface != null)
				newObject.m_SubGrp_GriddedSurface = (AE.SubGrp_GriddedSurface)m_SubGrp_GriddedSurface.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	One of the posible substitutions for _ParametricCurveSurface
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		/// 	<BR>This property is represented as an Element in the XML.</BR>
		...
		#region Attribute - SubGrp_GriddedSurface
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	One of the posible substitutions for _ParametricCurveSurface
		/// </summary>
		...
		///		<BR>Only one Element within this class may be set at a time, setting this property when another element is already set will raise an exception. setting this property to null will allow another element to be selected</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoChoiceClsOpt("SubGrp_GriddedSurface", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.SubGrp_GriddedSurface))]
		public AE.SubGrp_GriddedSurface SubGrp_GriddedSurface
		{
			get 
			{ 
				return m_SubGrp_GriddedSurface;  
			}
			set 
			{ 
				// The class represents a choice, so prevent more than one element from being selected
				ClearChoice((value == null)?"":"SubGrp_GriddedSurface"); // remove selection
				if (value == null)
					m_SubGrp_GriddedSurface = null;
				else
				{
					m_SubGrp_GriddedSurface = value; 
				}
			}
		}
		protected AE.SubGrp_GriddedSurface m_SubGrp_GriddedSurface;
