...
{
	/// <summary>
	/// 	This class represents the Element TimeCoordinateSystem
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TimeCoordinateSystem", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TimeCoordinateSystem : CSW.XmlCommonBase
					, AE.IAbstractTimeReferenceSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TimeCoordinateSystem
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public TimeCoordinateSystem()
		{
			_elementName = "TimeCoordinateSystem";
			Init();
		}
		public TimeCoordinateSystem(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TimeCoordinateSystem newObject = new AE.TimeCoordinateSystem(_elementName);
			newObject.m_Id = m_Id;
