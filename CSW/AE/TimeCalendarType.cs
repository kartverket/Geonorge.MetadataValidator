...
{
	/// <summary>
	/// 	This class represents the ComplexType TimeCalendarType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TimeCalendarType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TimeCalendarType : CSW.XmlCommonBase
					, AE.IAbstractTimeReferenceSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TimeCalendarType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TimeCalendarType";
			Init();
		}
		public TimeCalendarType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_ReferenceFrameCol = new CSW.XmlObjectCollection<AE.TimeCalendarEraPropertyType>("referenceFrame", "http://www.opengis.net/gml", 1, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TimeCalendarType newObject = new AE.TimeCalendarType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.TimeCalendarEraPropertyType o in m_ReferenceFrameCol)
				newObject.m_ReferenceFrameCol.Add((AE.TimeCalendarEraPropertyType)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - referenceFrame
		/// <summary>
		/// 	A collection of referenceFrameCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("referenceFrame", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.TimeCalendarEraPropertyType> ReferenceFrameCol
		{
			get { return m_ReferenceFrameCol; }
		}
		protected CSW.XmlObjectCollection<AE.TimeCalendarEraPropertyType> m_ReferenceFrameCol;
