...
{
	/// <summary>
	/// 	This class represents the Element DirectedObservationAtDistance
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DirectedObservationAtDistance", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DirectedObservationAtDistance : CSW.XmlCommonBase
					, AE.IDirectedObservationType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DirectedObservationAtDistance
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public DirectedObservationAtDistance()
		{
			_elementName = "DirectedObservationAtDistance";
			Init();
		}
		public DirectedObservationAtDistance(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DirectedObservationAtDistance newObject = new AE.DirectedObservationAtDistance(_elementName);
			newObject.m_Id = m_Id;
