...
{
	/// <summary>
	/// 	This class represents the Element temporalExtent
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"temporalExtent", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TemporalExtent : CSW.XmlCommonBase
					, AE.IAbstractTimeGeometricPrimitiveType
	{
		#region Constructors
		/// <summary>
		...
		{
			_elementName = "temporalExtent";
			Init();
		}
		public TemporalExtent(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_RelatedTimeCol = new CSW.XmlObjectCollection<AE.RelatedTimeType>("relatedTime", "http://www.opengis.net/gml", 0, -1, false);
			...
			m_IsValidFrame = true;
			m_TimePeriodType_Type_Seq_Choice = new AE.TimePeriodType_Type_Seq_Choice("TimePeriodType_Type_Seq_Choice");
			m_TimePeriodType_Type_Seq_ChoiceA = new AE.TimePeriodType_Type_Seq_ChoiceA("TimePeriodType_Type_Seq_ChoiceA");
			m_TimePeriodType_Type_Seq_ChoiceB = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TemporalExtent newObject = new AE.TemporalExtent(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.RelatedTimeType o in m_RelatedTimeCol)
				newObject.m_RelatedTimeCol.Add((AE.RelatedTimeType)o.Clone());
			newObject.m_Frame = m_Frame;
			newObject.m_IsValidFrame = m_IsValidFrame;
			newObject.m_TimePeriodType_Type_Seq_Choice = null;
			if (m_TimePeriodType_Type_Seq_Choice != null)
				newObject.m_TimePeriodType_Type_Seq_Choice = (AE.TimePeriodType_Type_Seq_Choice)m_TimePeriodType_Type_Seq_Choice.Clone();
			newObject.m_TimePeriodType_Type_Seq_ChoiceA = null;
			if (m_TimePeriodType_Type_Seq_ChoiceA != null)
				newObject.m_TimePeriodType_Type_Seq_ChoiceA = (AE.TimePeriodType_Type_Seq_ChoiceA)m_TimePeriodType_Type_Seq_ChoiceA.Clone();
			newObject.m_TimePeriodType_Type_Seq_ChoiceB = null;
			if (m_TimePeriodType_Type_Seq_ChoiceB != null)
				newObject.m_TimePeriodType_Type_Seq_ChoiceB = (AE.TimePeriodType_Type_Seq_ChoiceB)m_TimePeriodType_Type_Seq_ChoiceB.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - relatedTime
		/// <summary>
		/// 	A collection of relatedTimeCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// 	<BR>This collection may contain 0 to Many objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("relatedTime", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.RelatedTimeType> RelatedTimeCol
		{
			get { return m_RelatedTimeCol; }
		}
		protected CSW.XmlObjectCollection<AE.RelatedTimeType> m_RelatedTimeCol;
		...
		#region Attribute - TimePeriodType_Type_Seq_Choice
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("TimePeriodType_Type_Seq_Choice", "", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.TimePeriodType_Type_Seq_Choice), false)]
		public AE.TimePeriodType_Type_Seq_Choice TimePeriodType_Type_Seq_Choice
		{
			get 
			{ 
				return m_TimePeriodType_Type_Seq_Choice;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "TimePeriodType_Type_Seq_Choice");
				m_TimePeriodType_Type_Seq_Choice = value;
			}
		}
		protected AE.TimePeriodType_Type_Seq_Choice m_TimePeriodType_Type_Seq_Choice;
		
		#endregion

		#region Attribute - TimePeriodType_Type_Seq_ChoiceA
		/// <summary>
		///		Represents a mandatory Element in the XML document
		/// 	
		/// </summary>
		...
		///		<BR>If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("TimePeriodType_Type_Seq_ChoiceA", "", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.TimePeriodType_Type_Seq_ChoiceA), false)]
		public AE.TimePeriodType_Type_Seq_ChoiceA TimePeriodType_Type_Seq_ChoiceA
		{
			get 
			{ 
				return m_TimePeriodType_Type_Seq_ChoiceA;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "TimePeriodType_Type_Seq_ChoiceA");
				m_TimePeriodType_Type_Seq_ChoiceA = value;
			}
		}
		protected AE.TimePeriodType_Type_Seq_ChoiceA m_TimePeriodType_Type_Seq_ChoiceA;
		
		#endregion

		#region Attribute - TimePeriodType_Type_Seq_ChoiceB
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("TimePeriodType_Type_Seq_ChoiceB", "", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.TimePeriodType_Type_Seq_ChoiceB))]
		public AE.TimePeriodType_Type_Seq_ChoiceB TimePeriodType_Type_Seq_ChoiceB
		{
			get 
			{ 
				return m_TimePeriodType_Type_Seq_ChoiceB;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_TimePeriodType_Type_Seq_ChoiceB = value; 
				}
			}
		}
		protected AE.TimePeriodType_Type_Seq_ChoiceB m_TimePeriodType_Type_Seq_ChoiceB;
