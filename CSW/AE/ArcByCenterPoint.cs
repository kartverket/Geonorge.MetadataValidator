...
{
	/// <summary>
	/// 	This class represents the Element ArcByCenterPoint
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ArcByCenterPoint", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ArcByCenterPoint : CSW.XmlCommonBase
					, AE.IAbstractCurveSegmentType
					, AE.IArcByCenterPointType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ArcByCenterPoint
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public ArcByCenterPoint()
		{
			_elementName = "ArcByCenterPoint";
			Init();
		}
		public ArcByCenterPoint(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ArcByCenterPoint newObject = new AE.ArcByCenterPoint(_elementName);
