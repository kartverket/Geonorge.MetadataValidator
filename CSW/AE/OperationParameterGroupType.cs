...
{
	/// <summary>
	/// 	This class represents the ComplexType OperationParameterGroupType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"OperationParameterGroupType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class OperationParameterGroupType : CSW.XmlCommonBase
					, AE.IOperationParameterGroupBaseType
	{
		#region Constructors
		/// <summary>
		///		Constructor for OperationParameterGroupType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "OperationParameterGroupType";
			Init();
		}
		public OperationParameterGroupType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.OperationParameterGroupType newObject = new AE.OperationParameterGroupType(_elementName);
			newObject.m_Id = m_Id;
