...
{
	/// <summary>
	/// 	This class represents the Element MultiPolygon
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiPolygon", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiPolygon : CSW.XmlCommonBase
					, AE.IAbstractGeometricAggregateType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiPolygon
		/// </summary>
		/// <remarks>
		...
		public MultiPolygon()
		{
			_elementName = "MultiPolygon";
			Init();
		}
		public MultiPolygon(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiPolygon newObject = new AE.MultiPolygon(_elementName);
			newObject.m_Id = m_Id;
