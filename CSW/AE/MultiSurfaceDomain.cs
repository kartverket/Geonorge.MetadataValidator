...
{
	/// <summary>
	/// 	This class represents the Element multiSurfaceDomain
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"multiSurfaceDomain", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiSurfaceDomain : CSW.XmlCommonBase
					, AE.IDomainSetType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiSurfaceDomain
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "multiSurfaceDomain";
			Init();
		}
		public MultiSurfaceDomain(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiSurfaceDomain newObject = new AE.MultiSurfaceDomain(_elementName);
