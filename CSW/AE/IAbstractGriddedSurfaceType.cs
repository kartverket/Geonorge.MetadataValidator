...
{
	/// <summary>
	/// 	This class represents the abstract Element IAbstractGriddedSurfaceType
	/// </summary>
	/// <remarks>
	/// </remarks>
	public interface IAbstractGriddedSurfaceType : LiquidTechnologies.Runtime.Net45.XmlObjectInterface
