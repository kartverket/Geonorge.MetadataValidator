...
{
	/// <summary>
	/// 	This class represents the ComplexType DynamicFeatureType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DynamicFeatureType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DynamicFeatureType : CSW.XmlCommonBase
					, AE.IAbstractFeatureType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DynamicFeatureType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DynamicFeatureType";
			Init();
		}
		public DynamicFeatureType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DynamicFeatureType newObject = new AE.DynamicFeatureType(_elementName);
			newObject.m_Id = m_Id;
