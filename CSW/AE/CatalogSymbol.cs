...
{
	/// <summary>
	/// 	This class represents the Element catalogSymbol
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"catalogSymbol", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class CatalogSymbol : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CatalogSymbol
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "catalogSymbol";
			Init();
		}
		public CatalogSymbol(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CatalogSymbol newObject = new AE.CatalogSymbol(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element CatalogSymbol, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;CatalogSymbol&gt;Some Data&lt;/CatalogSymbol&gt;</BR>
		/// </remarks>
