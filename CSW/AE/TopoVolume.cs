...
{
	/// <summary>
	/// 	This class represents the Element TopoVolume
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TopoVolume", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TopoVolume : CSW.XmlCommonBase
					, AE.IAbstractTopologyType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TopoVolume
		/// </summary>
		/// <remarks>
		...
		public TopoVolume()
		{
			_elementName = "TopoVolume";
			Init();
		}
		public TopoVolume(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TopoVolume newObject = new AE.TopoVolume(_elementName);
			newObject.m_Id = m_Id;
