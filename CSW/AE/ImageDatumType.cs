...
{
	/// <summary>
	/// 	This class represents the ComplexType ImageDatumType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ImageDatumType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ImageDatumType : CSW.XmlCommonBase
					, AE.IAbstractDatumType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ImageDatumType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "ImageDatumType";
			Init();
		}
		public ImageDatumType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_PixelInCell = new AE.PixelInCell("pixelInCell");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ImageDatumType newObject = new AE.ImageDatumType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_PixelInCell = null;
			if (m_PixelInCell != null)
				newObject.m_PixelInCell = (AE.PixelInCell)m_PixelInCell.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("pixelInCell", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.PixelInCell), false)]
		public AE.PixelInCell PixelInCell
		{
			get 
			{ 
				return m_PixelInCell;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "pixelInCell");
				m_PixelInCell = value;
			}
		}
		protected AE.PixelInCell m_PixelInCell;
