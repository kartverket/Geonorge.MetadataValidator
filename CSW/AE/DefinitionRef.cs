...
{
	/// <summary>
	/// 	This class represents the Element definitionRef
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"definitionRef", "http://www.opengis.net/gml", true, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DefinitionRef : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for DefinitionRef
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "definitionRef";
			Init();
		}
		public DefinitionRef(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DefinitionRef newObject = new AE.DefinitionRef(_elementName);
