...
{
	/// <summary>
	/// 	This class represents the Element metaDataProperty
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"metaDataProperty", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MetaDataProperty : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for MetaDataProperty
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "metaDataProperty";
			Init();
		}
		public MetaDataProperty(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_About = "";
			m_IsValidAbout = false;
			m_MetaDataProperty_Group = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MetaDataProperty newObject = new AE.MetaDataProperty(_elementName);
			...
			newObject.m_About = m_About;
			newObject.m_IsValidAbout = m_IsValidAbout;
			newObject.m_MetaDataProperty_Group = null;
			if (m_MetaDataProperty_Group != null)
				newObject.m_MetaDataProperty_Group = (AE.MetaDataProperty_Group)m_MetaDataProperty_Group.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// 	<BR>It is optional, initially it is not valid.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.AttributeInfoPrimitive("about", "", "IsValidAbout", LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Collapse, null, "", -1, -1, "", "", "", "", -1)]
		public String About
		{
			get 
			{ 
				if (m_IsValidAbout == false)
					throw new LiquidTechnologies.Runtime.Net45.LtInvalidStateException("The Property about is not valid. Set aboutValid = true");
				return m_About;  
			}
			set 
			{ 
		...
		/// <summary>
		/// 	Indicates if about contains a valid value.
		/// </summary>
		/// <remarks>
		/// 	<BR>true if the value for about is valid, false if not.</BR>
		///		<BR>If this is set to true then the property is considered valid, and assigned its
		///		default value ("").</BR>
		///		<BR>If its set to false then its made invalid, and subsequent calls to get about
		///		will raise an exception.</BR>
		/// </remarks>
		public Boolean IsValidAbout
		{
			get
			{
				return m_IsValidAbout;
			}
			set 
			{ 
				if (value != m_IsValidAbout)
				{
					About = "";
					m_IsValidAbout = value;
				}
			}
		}
		protected Boolean m_IsValidAbout;
		protected String m_About;
		#endregion

		#region Attribute - metaDataProperty_Group
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("metaDataProperty_Group", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.MetaDataProperty_Group))]
		public AE.MetaDataProperty_Group MetaDataProperty_Group
		{
			get 
			{ 
				return m_MetaDataProperty_Group;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_MetaDataProperty_Group = value; 
				}
			}
		}
		protected AE.MetaDataProperty_Group m_MetaDataProperty_Group;
