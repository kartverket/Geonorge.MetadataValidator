...
{
	/// <summary>
	/// 	This class represents the Element PrimeMeridian
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PrimeMeridian", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PrimeMeridian : CSW.XmlCommonBase
					, AE.IPrimeMeridianBaseType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PrimeMeridian
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PrimeMeridian";
			Init();
		}
		public PrimeMeridian(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.PrimeMeridian newObject = new AE.PrimeMeridian(_elementName);
			newObject.m_Id = m_Id;
