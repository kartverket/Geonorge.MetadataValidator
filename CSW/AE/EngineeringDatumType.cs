...
{
	/// <summary>
	/// 	This class represents the ComplexType EngineeringDatumType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"EngineeringDatumType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class EngineeringDatumType : CSW.XmlCommonBase
					, AE.IAbstractDatumType
	{
		#region Constructors
		/// <summary>
		///		Constructor for EngineeringDatumType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "EngineeringDatumType";
			Init();
		}
		public EngineeringDatumType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.EngineeringDatumType newObject = new AE.EngineeringDatumType(_elementName);
			newObject.m_Id = m_Id;
