...
{
	/// <summary>
	/// 	This class represents the Element maximalComplex
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"maximalComplex", "http://www.opengis.net/gml", true, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MaximalComplex : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for MaximalComplex
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "maximalComplex";
			Init();
		}
		public MaximalComplex(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MaximalComplex newObject = new AE.MaximalComplex(_elementName);
