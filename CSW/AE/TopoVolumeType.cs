...
{
	/// <summary>
	/// 	This class represents the ComplexType TopoVolumeType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TopoVolumeType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TopoVolumeType : CSW.XmlCommonBase
					, AE.IAbstractTopologyType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TopoVolumeType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TopoVolumeType";
			Init();
		}
		public TopoVolumeType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_DirectedTopoSolidCol = new CSW.XmlObjectCollection<AE.DirectedTopoSolid>("directedTopoSolid", "http://www.opengis.net/gml", 1, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TopoVolumeType newObject = new AE.TopoVolumeType(_elementName);
			newObject.m_Id = m_Id;
