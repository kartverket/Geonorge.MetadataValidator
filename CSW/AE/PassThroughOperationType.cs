...
{
	/// <summary>
	/// 	This class represents the ComplexType PassThroughOperationType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PassThroughOperationType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PassThroughOperationType : CSW.XmlCommonBase
					, AE.IAbstractCoordinateOperationType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PassThroughOperationType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PassThroughOperationType";
			Init();
		}
		public PassThroughOperationType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_SourceCRS = null;
			m_TargetCRS = null;
			m_ModifiedCoordinateCol = new CSW.XmlSimpleTypeCollection<LiquidTechnologies.Runtime.Net45.BigInteger>("modifiedCoordinate", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_integer, 1, -1, null, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Collapse, new LiquidTechnologies.Runtime.Net45.PrimitiveRestrictions("", -1, -1, "1", "", "", "", -1));
			m_UsesOperation = new AE.UsesOperation("usesOperation");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.PassThroughOperationType newObject = new AE.PassThroughOperationType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (LiquidTechnologies.Runtime.Net45.BigInteger o in m_ModifiedCoordinateCol)
				newObject.m_ModifiedCoordinateCol.Add(o);
			newObject.m_UsesOperation = null;
			if (m_UsesOperation != null)
				newObject.m_UsesOperation = (AE.UsesOperation)m_UsesOperation.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - modifiedCoordinate
		/// <summary>
		///		A collection of LiquidTechnologies.Runtime.Net45.BigIntegers
		///		
		/// </summary>
		/// <remarks>
		///		<BR></BR>
		///		<BR>This property is represented as an Element in the XML.</BR>
		///		<BR>This collection may contain 1 to Many LiquidTechnologies.Runtime.Net45.BigIntegers.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimCol("modifiedCoordinate", "http://www.opengis.net/gml")]
		public CSW.XmlSimpleTypeCollection<LiquidTechnologies.Runtime.Net45.BigInteger> ModifiedCoordinateCol
		{
			get { return m_ModifiedCoordinateCol; }
		}
		protected CSW.XmlSimpleTypeCollection<LiquidTechnologies.Runtime.Net45.BigInteger> m_ModifiedCoordinateCol;

		#endregion

		#region Attribute - usesOperation
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("usesOperation", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.UsesOperation), false)]
		public AE.UsesOperation UsesOperation
		{
			get 
			{ 
				return m_UsesOperation;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "usesOperation");
				m_UsesOperation = value;
			}
		}
		protected AE.UsesOperation m_UsesOperation;
