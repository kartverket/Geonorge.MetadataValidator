...
{
	/// <summary>
	/// 	This class represents the ComplexType LabelStyleType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"LabelStyleType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class LabelStyleType : CSW.XmlCommonBase
					, AE.IBaseStyleDescriptorType
	{
		#region Constructors
		/// <summary>
		///		Constructor for LabelStyleType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "LabelStyleType";
			Init();
		}
		public LabelStyleType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_Style = "";
			m_Label = new AE.LabelType("label");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.LabelStyleType newObject = new AE.LabelStyleType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_Label = null;
			if (m_Label != null)
				newObject.m_Label = (AE.LabelType)m_Label.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimMnd("style", "http://www.opengis.net/gml", null, LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Preserve, "", -1, -1, "", "", "", "", -1)]
		public String Style
		{
			get 
			{ 
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("label", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.LabelType), false)]
		public AE.LabelType Label
		{
			get 
			{ 
				return m_Label;  
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "label");
				if (value != null)
					SetElementName(value, "label");
				m_Label = value;
			}
		}
		protected AE.LabelType m_Label;
