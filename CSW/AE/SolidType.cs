...
{
	/// <summary>
	/// 	This class represents the ComplexType SolidType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"SolidType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class SolidType : CSW.XmlCommonBase
					, AE.IAbstractSolidType
	{
		#region Constructors
		/// <summary>
		///		Constructor for SolidType
		/// </summary>
		/// <remarks>
		...
		public SolidType()
		{
			_elementName = "SolidType";
			Init();
		}
		public SolidType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_Exterior = null;
			m_InteriorCol = new CSW.XmlObjectCollection<AE.SurfacePropertyType>("interior", "http://www.opengis.net/gml", 0, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.SolidType newObject = new AE.SolidType(_elementName);
			newObject.m_Id = m_Id;
			...
			if (m_Exterior != null)
				newObject.m_Exterior = (AE.SurfacePropertyType)m_Exterior.Clone();
			foreach (AE.SurfacePropertyType o in m_InteriorCol)
				newObject.m_InteriorCol.Add((AE.SurfacePropertyType)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("exterior", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.SurfacePropertyType))]
		public AE.SurfacePropertyType Exterior
		{
			get 
			{ 
				return m_Exterior;  
			...
			{ 
				...
				{
					SetElementName(value, "exterior");
					m_Exterior = value; 
				}
			}
		}
		protected AE.SurfacePropertyType m_Exterior;
		...
		/// 	<BR>This collection may contain 0 to Many objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("interior", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.SurfacePropertyType> InteriorCol
		{
			get { return m_InteriorCol; }
		}
		protected CSW.XmlObjectCollection<AE.SurfacePropertyType> m_InteriorCol;
