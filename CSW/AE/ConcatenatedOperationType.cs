...
{
	/// <summary>
	/// 	This class represents the ComplexType ConcatenatedOperationType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ConcatenatedOperationType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ConcatenatedOperationType : CSW.XmlCommonBase
					, AE.IAbstractCoordinateOperationType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ConcatenatedOperationType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "ConcatenatedOperationType";
			Init();
		}
		public ConcatenatedOperationType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_SourceCRS = null;
			m_TargetCRS = null;
			m_UsesSingleOperationCol = new CSW.XmlObjectCollection<AE.UsesSingleOperation>("usesSingleOperation", "http://www.opengis.net/gml", 2, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ConcatenatedOperationType newObject = new AE.ConcatenatedOperationType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.UsesSingleOperation o in m_UsesSingleOperationCol)
				newObject.m_UsesSingleOperationCol.Add((AE.UsesSingleOperation)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - usesSingleOperation
		/// <summary>
		/// 	A collection of usesSingleOperationCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("usesSingleOperation", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.UsesSingleOperation> UsesSingleOperationCol
		{
			get { return m_UsesSingleOperationCol; }
		}
		protected CSW.XmlObjectCollection<AE.UsesSingleOperation> m_UsesSingleOperationCol;
