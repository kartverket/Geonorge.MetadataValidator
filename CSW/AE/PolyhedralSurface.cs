...
{
	/// <summary>
	/// 	This class represents the Element PolyhedralSurface
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PolyhedralSurface", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PolyhedralSurface : CSW.XmlCommonBase
					, AE.ISurfaceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PolyhedralSurface
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PolyhedralSurface";
			Init();
		}
		public PolyhedralSurface(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.PolyhedralSurface newObject = new AE.PolyhedralSurface(_elementName);
			newObject.m_Id = m_Id;
