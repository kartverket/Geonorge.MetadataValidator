...
{
	/// <summary>
	/// 	This class represents the ComplexType DynamicFeatureCollectionType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DynamicFeatureCollectionType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DynamicFeatureCollectionType : CSW.XmlCommonBase
					, AE.IFeatureCollectionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DynamicFeatureCollectionType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DynamicFeatureCollectionType";
			Init();
		}
		public DynamicFeatureCollectionType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DynamicFeatureCollectionType newObject = new AE.DynamicFeatureCollectionType(_elementName);
			newObject.m_Id = m_Id;
			...
			if (m_History != null)
				newObject.m_History = (AE.SubGrphistory)m_History.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqAbsClsOpt("validTime", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.ClassFactory), "ITimePrimitivePropertyTypeCreateObject")]
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("history", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.SubGrphistory))]
		public AE.SubGrphistory History
		{
			get 
			{ 
				return m_History;  
		...
		protected AE.SubGrphistory m_History;
