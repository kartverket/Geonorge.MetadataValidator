...
{
	/// <summary>
	/// 	This class represents the ComplexType SurfacePatchArrayPropertyType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"SurfacePatchArrayPropertyType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class SurfacePatchArrayPropertyType : CSW.XmlCommonBase
					, AE.ISurfacePatchArrayPropertyType
	{
		#region Constructors
		/// <summary>
		///		Constructor for SurfacePatchArrayPropertyType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "SurfacePatchArrayPropertyType";
			Init();
		}
		public SurfacePatchArrayPropertyType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.SurfacePatchArrayPropertyType newObject = new AE.SurfacePatchArrayPropertyType(_elementName);
