...
{
	/// <summary>
	/// 	This class represents the ComplexType EllipsoidalCSType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"EllipsoidalCSType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class EllipsoidalCSType : CSW.XmlCommonBase
					, AE.IAbstractCoordinateSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for EllipsoidalCSType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "EllipsoidalCSType";
			Init();
		}
		public EllipsoidalCSType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.EllipsoidalCSType newObject = new AE.EllipsoidalCSType(_elementName);
			newObject.m_Id = m_Id;
