...
{
	/// <summary>
	/// 	This class represents the ComplexType LinearCSType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"LinearCSType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class LinearCSType : CSW.XmlCommonBase
					, AE.IAbstractCoordinateSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for LinearCSType
		/// </summary>
		/// <remarks>
		...
		public LinearCSType()
		{
			_elementName = "LinearCSType";
			Init();
		}
		public LinearCSType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.LinearCSType newObject = new AE.LinearCSType(_elementName);
			newObject.m_Id = m_Id;
