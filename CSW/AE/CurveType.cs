...
{
	/// <summary>
	/// 	This class represents the ComplexType CurveType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CurveType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CurveType : CSW.XmlCommonBase
					, AE.IAbstractCurveType
	{
		...
		public CurveType()
		{
			_elementName = "CurveType";
			Init();
		}
		public CurveType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_Segments = new AE.Segments("segments");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CurveType newObject = new AE.CurveType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_Segments = null;
			if (m_Segments != null)
				newObject.m_Segments = (AE.Segments)m_Segments.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("segments", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.Segments), false)]
		public AE.Segments Segments
		{
			get 
			{ 
				return m_Segments;  
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "segments");
				m_Segments = value;
			}
		}
		protected AE.Segments m_Segments;
