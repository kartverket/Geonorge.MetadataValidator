...
{
	/// <summary>
	/// 	This class represents the Element OrientableSurface
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"OrientableSurface", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class OrientableSurface : CSW.XmlCommonBase
					, AE.IAbstractSurfaceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for OrientableSurface
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "OrientableSurface";
			Init();
		}
		public OrientableSurface(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.OrientableSurface newObject = new AE.OrientableSurface(_elementName);
			newObject.m_Id = m_Id;
