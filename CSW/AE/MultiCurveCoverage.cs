...
{
	/// <summary>
	/// 	This class represents the Element MultiCurveCoverage
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiCurveCoverage", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiCurveCoverage : CSW.XmlCommonBase
					, AE.IAbstractDiscreteCoverageType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiCurveCoverage
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "MultiCurveCoverage";
			Init();
		}
		public MultiCurveCoverage(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiCurveCoverage newObject = new AE.MultiCurveCoverage(_elementName);
			newObject.m_Id = m_Id;
