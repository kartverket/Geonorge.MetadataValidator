...
{
	/// <summary>
	/// 	This class represents the Element targetCRS
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"targetCRS", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TargetCRS : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for TargetCRS
		/// </summary>
		/// <remarks>
		...
		public TargetCRS()
		{
			_elementName = "targetCRS";
			Init();
		}
		public TargetCRS(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TargetCRS newObject = new AE.TargetCRS(_elementName);
			...
			newObject.m_TargetCRS_Group = null;
			if (m_TargetCRS_Group != null)
				newObject.m_TargetCRS_Group = (AE.TargetCRS_Group)m_TargetCRS_Group.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - targetCRS_Group
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("targetCRS_Group", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.TargetCRS_Group))]
		public AE.TargetCRS_Group TargetCRS_Group
		{
			get 
			{ 
				return m_TargetCRS_Group;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_TargetCRS_Group = value; 
				}
			}
		}
		protected AE.TargetCRS_Group m_TargetCRS_Group;
