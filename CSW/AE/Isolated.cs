...
{
	/// <summary>
	/// 	This class represents the Element isolated
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"isolated", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class Isolated : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		...
		public Isolated()
		{
			_elementName = "isolated";
			Init();
		}
		public Isolated(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.Isolated newObject = new AE.Isolated(_elementName);
			...
			newObject.m_Isolated_Group = null;
			if (m_Isolated_Group != null)
				newObject.m_Isolated_Group = (AE.Isolated_Group)m_Isolated_Group.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - isolated_Group
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("isolated_Group", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.Isolated_Group))]
		public AE.Isolated_Group Isolated_Group
		{
			get 
			{ 
				return m_Isolated_Group;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_Isolated_Group = value; 
				}
			}
		}
		protected AE.Isolated_Group m_Isolated_Group;
