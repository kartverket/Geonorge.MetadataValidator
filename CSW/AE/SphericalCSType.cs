...
{
	/// <summary>
	/// 	This class represents the ComplexType SphericalCSType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"SphericalCSType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class SphericalCSType : CSW.XmlCommonBase
					, AE.IAbstractCoordinateSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for SphericalCSType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "SphericalCSType";
			Init();
		}
		public SphericalCSType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.SphericalCSType newObject = new AE.SphericalCSType(_elementName);
			newObject.m_Id = m_Id;
