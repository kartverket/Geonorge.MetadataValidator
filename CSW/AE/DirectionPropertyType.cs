...
{
	/// <summary>
	/// 	This class represents the ComplexType DirectionPropertyType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DirectionPropertyType", "http://www.opengis.net/gml", true, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DirectionPropertyType : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for DirectionPropertyType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DirectionPropertyType";
			Init();
		}
		public DirectionPropertyType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_CompassPoint = AE.Enumerations.CompassPointEnumeration.N;
			m_IsValidCompassPoint = false;
			m_DirectionKeyword = null;
			m_DirectionString = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DirectionPropertyType newObject = new AE.DirectionPropertyType(_elementName);
			...
			newObject.m_DirectionVector = null;
			if (m_DirectionVector != null)
				newObject.m_DirectionVector = (AE.DirectionVector)m_DirectionVector.Clone();
			newObject.m_CompassPoint = m_CompassPoint;
			newObject.m_IsValidCompassPoint = m_IsValidCompassPoint;
			newObject.m_DirectionKeyword = null;
			if (m_DirectionKeyword != null)
				newObject.m_DirectionKeyword = (AE.ICodeType)m_DirectionKeyword.Clone();
			newObject.m_DirectionString = null;
			if (m_DirectionString != null)
				newObject.m_DirectionString = (AE.StringOrRefType)m_DirectionString.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - DirectionVector
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoChoiceClsOpt("DirectionVector", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.DirectionVector))]
		public AE.DirectionVector DirectionVector
		{
			get 
			{ 
			...
			{ 
				...
				ClearChoice((value == null)?"":"DirectionVector"); // remove selection
				if (value == null)
					m_DirectionVector = null;
				else
				{
		...
		protected AE.DirectionVector m_DirectionVector;
		
		#endregion

		#region Attribute - CompassPoint
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		/// 	<BR>This property is represented as an Element in the XML.</BR>
		/// 	<BR>It is optional, initially it is not valid.</BR>
		///		<BR>Only one Element within this class may be set at a time, setting this property when another element is already set will raise an exception. Set CompassPointValid = false to de-select this element</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoChoiceEnumOpt("CompassPoint", "http://www.opengis.net/gml", "IsValidCompassPoint", null, typeof(AE.Enumerations), "CompassPointEnumerationFromString", "CompassPointEnumerationToString")]
		public AE.Enumerations.CompassPointEnumeration CompassPoint
		{
			get 
			{ 
				if (m_IsValidCompassPoint == false)
					throw new LiquidTechnologies.Runtime.Net45.LtInvalidStateException("The Property CompassPoint is not valid. Set CompassPointValid = true");
				return m_CompassPoint;  
			}
			set 
			{ 
				// The class represents a choice, so prevent more than one element from being selected
				ClearChoice("CompassPoint"); // remove selection
				m_CompassPoint = value;
				m_IsValidCompassPoint = true;
			}
		}
		/// <summary>
		/// 	Indicates if CompassPoint contains a valid value.
		/// </summary>
		/// <remarks>
		/// 	<BR>true if the value for CompassPoint is valid, false if not.</BR>
		///		<BR>If this is set to true then the property is considered valid, and assigned its
		///		default value (AE.Enumerations.CompassPointEnumeration.N).</BR>
		///		<BR>If its set to false then its made invalid, and subsequent calls to get CompassPoint
		///		will raise an exception.</BR>
		/// </remarks>
		public Boolean IsValidCompassPoint
		{
			get { return m_IsValidCompassPoint;  }
			set 
			{ 
				if (value != m_IsValidCompassPoint)
				{
					// Ensure only one element at a time is populated
					Choice_SetElementValid(value, "CompassPoint", ref _validElement);
					CompassPoint = AE.Enumerations.CompassPointEnumeration.N;
					m_IsValidCompassPoint = value;
				}
			}
		}
		protected AE.Enumerations.CompassPointEnumeration m_CompassPoint;
		protected Boolean m_IsValidCompassPoint;

		#endregion

		#region Attribute - DirectionKeyword
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		///		<BR>Only one Element within this class may be set at a time, setting this property when another element is already set will raise an exception. setting this property to null will allow another element to be selected</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoChoiceAbsClsOpt("DirectionKeyword", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.ClassFactory), "ICodeTypeCreateObject")]
		public AE.ICodeType DirectionKeyword
		{
			get 
			{ 
				return m_DirectionKeyword;  
			}
			set 
			{ 
				// The class represents a choice, so prevent more than one element from being selected
				ClearChoice((value == null)?"":"DirectionKeyword"); // remove selection
				if (value == null)
					m_DirectionKeyword = null;
				else
				{
					m_DirectionKeyword = value; 
					// The object being set needs to take the element name from the class (the type="" attribute will then be set in the XML)
					SetElementName(value.GetBase(), "DirectionKeyword");
				}
			}
		}
		protected AE.ICodeType m_DirectionKeyword;

		#endregion

		#region Attribute - DirectionString
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		///		<BR>Only one Element within this class may be set at a time, setting this property when another element is already set will raise an exception. setting this property to null will allow another element to be selected</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoChoiceClsOpt("DirectionString", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.StringOrRefType))]
		public AE.StringOrRefType DirectionString
		{
			get 
			{ 
			...
			{ 
				// The class represents a choice, so prevent more than one element from being selected
				ClearChoice((value == null)?"":"DirectionString"); // remove selection
				if (value == null)
					m_DirectionString = null;
				else
				{
					SetElementName(value, "DirectionString");
					m_DirectionString = value; 
				}
			}
		}
		protected AE.StringOrRefType m_DirectionString;
