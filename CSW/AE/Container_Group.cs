...
{
	/// <summary>
	/// 	This class represents the Element container_Group
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"container_Group", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class Container_Group : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for Container_Group
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "container_Group";
			Init();
		}
		public Container_Group(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.Container_Group newObject = new AE.Container_Group(_elementName);
