...
{
	/// <summary>
	/// 	This class represents the ComplexType AbsoluteExternalPositionalAccuracyType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"AbsoluteExternalPositionalAccuracyType", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class AbsoluteExternalPositionalAccuracyType : CSW.XmlCommonBase
					, AE.IAbstractPositionalAccuracyType
	{
		#region Constructors
		/// <summary>
		///		Constructor for AbsoluteExternalPositionalAccuracyType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "AbsoluteExternalPositionalAccuracyType";
			Init();
		}
		public AbsoluteExternalPositionalAccuracyType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.AbsoluteExternalPositionalAccuracyType newObject = new AE.AbsoluteExternalPositionalAccuracyType(_elementName);
