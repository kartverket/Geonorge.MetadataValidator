...
{
	/// <summary>
	/// 	This class represents the Element ProjectedCRS
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ProjectedCRS", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ProjectedCRS : CSW.XmlCommonBase
					, AE.IAbstractGeneralDerivedCRSType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ProjectedCRS
		/// </summary>
		/// <remarks>
		...
		public ProjectedCRS()
		{
			_elementName = "ProjectedCRS";
			Init();
		}
		public ProjectedCRS(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ProjectedCRS newObject = new AE.ProjectedCRS(_elementName);
			newObject.m_Id = m_Id;
