...
{
	/// <summary>
	/// 	This class represents the ComplexType RectifiedGridCoverageType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"RectifiedGridCoverageType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class RectifiedGridCoverageType : CSW.XmlCommonBase
					, AE.IAbstractDiscreteCoverageType
	{
		#region Constructors
		/// <summary>
		///		Constructor for RectifiedGridCoverageType
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public RectifiedGridCoverageType()
		{
			_elementName = "RectifiedGridCoverageType";
			Init();
		}
		public RectifiedGridCoverageType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_Location = null;
			m_Dimension = 0;
			m_IsValidDimension = false;
			m_DomainSet = new AE.SubGrpdomainSet("domainSet");
			m_RangeSet = new AE.RangeSet("rangeSet");
			m_CoverageFunction = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.RectifiedGridCoverageType newObject = new AE.RectifiedGridCoverageType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_Dimension = m_Dimension;
			newObject.m_IsValidDimension = m_IsValidDimension;
			newObject.m_DomainSet = null;
			if (m_DomainSet != null)
				newObject.m_DomainSet = (AE.SubGrpdomainSet)m_DomainSet.Clone();
			newObject.m_RangeSet = null;
			if (m_RangeSet != null)
				newObject.m_RangeSet = (AE.RangeSet)m_RangeSet.Clone();
			newObject.m_CoverageFunction = null;
			if (m_CoverageFunction != null)
				newObject.m_CoverageFunction = (AE.CoverageFunction)m_CoverageFunction.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// 	<BR>It is optional, initially it is not valid.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.AttributeInfoPrimitive("dimension", "", "IsValidDimension", LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_integer, null, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Collapse, null, "", -1, -1, "", "", "", "", -1)]
		public LiquidTechnologies.Runtime.Net45.BigInteger Dimension
		{
			get 
			{ 
				if (m_IsValidDimension == false)
					throw new LiquidTechnologies.Runtime.Net45.LtInvalidStateException("The Property dimension is not valid. Set dimensionValid = true");
				return m_Dimension;  
			}
			set 
			{ 
				m_IsValidDimension = true;
				m_Dimension = value;
			}
		}
		/// <summary>
		/// 	Indicates if dimension contains a valid value.
		/// </summary>
		/// <remarks>
		/// 	<BR>true if the value for dimension is valid, false if not.</BR>
		///		<BR>If this is set to true then the property is considered valid, and assigned its
		///		default value (0).</BR>
		///		<BR>If its set to false then its made invalid, and subsequent calls to get dimension
		///		will raise an exception.</BR>
		/// </remarks>
		public Boolean IsValidDimension
		{
			get
			{
				return m_IsValidDimension;
			}
			set 
			{ 
				if (value != m_IsValidDimension)
				{
					Dimension = 0;
					m_IsValidDimension = value;
				}
			}
		}
		protected Boolean m_IsValidDimension;
		protected LiquidTechnologies.Runtime.Net45.BigInteger m_Dimension;
		#endregion
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("domainSet", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.SubGrpdomainSet), false)]
		public AE.SubGrpdomainSet DomainSet
		{
			get 
			{ 
				return m_DomainSet;  
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "domainSet");
				m_DomainSet = value;
			}
		}
		protected AE.SubGrpdomainSet m_DomainSet;
		...
		///		<BR>If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("rangeSet", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.RangeSet), true)]
		public AE.RangeSet RangeSet
		{
			get 
			{ 
				return m_RangeSet;  
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "rangeSet");
				m_RangeSet = value;
			}
		}
		protected AE.RangeSet m_RangeSet;
		
		#endregion

		#region Attribute - coverageFunction
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("coverageFunction", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.CoverageFunction))]
		public AE.CoverageFunction CoverageFunction
		{
			get 
			{ 
				return m_CoverageFunction;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_CoverageFunction = value; 
				}
			}
		}
		protected AE.CoverageFunction m_CoverageFunction;
