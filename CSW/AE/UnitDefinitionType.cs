...
{
	/// <summary>
	/// 	This class represents the ComplexType UnitDefinitionType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"UnitDefinitionType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class UnitDefinitionType : CSW.XmlCommonBase
					, AE.IUnitDefinitionType
					, AE.IDefinitionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for UnitDefinitionType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "UnitDefinitionType";
			Init();
		}
		public UnitDefinitionType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.UnitDefinitionType newObject = new AE.UnitDefinitionType(_elementName);
			newObject.m_Id = m_Id;
