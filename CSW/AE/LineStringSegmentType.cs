...
{
	/// <summary>
	/// 	This class represents the ComplexType LineStringSegmentType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"LineStringSegmentType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class LineStringSegmentType : CSW.XmlCommonBase
					, AE.IAbstractCurveSegmentType
	{
		#region Constructors
		/// <summary>
		///		Constructor for LineStringSegmentType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "LineStringSegmentType";
			Init();
		}
		public LineStringSegmentType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_LineStringSegmentTypeData = new AE.LineStringSegmentType_Type("LineStringSegmentTypeData");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.LineStringSegmentType newObject = new AE.LineStringSegmentType(_elementName);
			...
			newObject.m_LineStringSegmentTypeData = null;
			if (m_LineStringSegmentTypeData != null)
				newObject.m_LineStringSegmentTypeData = (AE.LineStringSegmentType_Type)m_LineStringSegmentTypeData.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - LineStringSegmentTypeData
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("LineStringSegmentTypeData", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.LineStringSegmentType_Type), true)]
		public AE.LineStringSegmentType_Type LineStringSegmentTypeData
		{
			get 
			{ 
				return m_LineStringSegmentTypeData;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "LineStringSegmentTypeData");
				m_LineStringSegmentTypeData = value;
			}
		}
		protected AE.LineStringSegmentType_Type m_LineStringSegmentTypeData;
