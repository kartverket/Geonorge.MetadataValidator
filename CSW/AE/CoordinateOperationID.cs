...
{
	/// <summary>
	/// 	This class represents the Element coordinateOperationID
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"coordinateOperationID", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CoordinateOperationID : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for CoordinateOperationID
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public CoordinateOperationID()
		{
			_elementName = "coordinateOperationID";
			Init();
		}
		public CoordinateOperationID(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CoordinateOperationID newObject = new AE.CoordinateOperationID(_elementName);
			newObject.m_Name = null;
			if (m_Name != null)
				newObject.m_Name = (AE.SubGrpname)m_Name.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("name", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.SubGrpname), false)]
		public AE.SubGrpname Name
		{
			get 
			{ 
				return m_Name;  
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "name");
				m_Name = value;
			}
		}
		protected AE.SubGrpname m_Name;
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimOpt("version", "http://www.opengis.net/gml", "IsValidVersion", null, LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Preserve, "", -1, -1, "", "", "", "", -1)]
