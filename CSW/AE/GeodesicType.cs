...
{
	/// <summary>
	/// 	This class represents the ComplexType GeodesicType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GeodesicType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GeodesicType : CSW.XmlCommonBase
					, AE.IGeodesicStringType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GeodesicType
		/// </summary>
		/// <remarks>
		...
		public GeodesicType()
		{
			_elementName = "GeodesicType";
			Init();
		}
		public GeodesicType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.GeodesicType newObject = new AE.GeodesicType(_elementName);
