...
{
	/// <summary>
	/// 	This class represents the ComplexType CompositeSurfaceType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CompositeSurfaceType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CompositeSurfaceType : CSW.XmlCommonBase
					, AE.IAbstractSurfaceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CompositeSurfaceType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CompositeSurfaceType";
			Init();
		}
		public CompositeSurfaceType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_SurfaceMemberCol = new CSW.XmlObjectCollection<AE.SurfaceMember>("surfaceMember", "http://www.opengis.net/gml", 1, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CompositeSurfaceType newObject = new AE.CompositeSurfaceType(_elementName);
			newObject.m_Id = m_Id;
