...
{
	/// <summary>
	/// 	This class represents the ComplexType CovarianceMatrixType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CovarianceMatrixType", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CovarianceMatrixType : CSW.XmlCommonBase
					, AE.IAbstractPositionalAccuracyType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CovarianceMatrixType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CovarianceMatrixType";
			Init();
		}
		public CovarianceMatrixType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CovarianceMatrixType newObject = new AE.CovarianceMatrixType(_elementName);
