...
{
	/// <summary>
	/// 	This class represents the Element CompositeCurve
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CompositeCurve", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CompositeCurve : CSW.XmlCommonBase
					, AE.IAbstractCurveType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CompositeCurve
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CompositeCurve";
			Init();
		}
		public CompositeCurve(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CompositeCurve newObject = new AE.CompositeCurve(_elementName);
			newObject.m_Id = m_Id;
