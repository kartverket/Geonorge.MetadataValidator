...
{
	/// <summary>
	/// 	This class represents the Element CompositeSurface
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CompositeSurface", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CompositeSurface : CSW.XmlCommonBase
					, AE.IAbstractSurfaceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CompositeSurface
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CompositeSurface";
			Init();
		}
		public CompositeSurface(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CompositeSurface newObject = new AE.CompositeSurface(_elementName);
			newObject.m_Id = m_Id;
