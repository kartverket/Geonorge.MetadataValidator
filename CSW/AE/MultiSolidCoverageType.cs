...
{
	/// <summary>
	/// 	This class represents the ComplexType MultiSolidCoverageType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiSolidCoverageType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiSolidCoverageType : CSW.XmlCommonBase
					, AE.IAbstractDiscreteCoverageType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiSolidCoverageType
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public MultiSolidCoverageType()
		{
			_elementName = "MultiSolidCoverageType";
			Init();
		}
		public MultiSolidCoverageType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiSolidCoverageType newObject = new AE.MultiSolidCoverageType(_elementName);
			newObject.m_Id = m_Id;
