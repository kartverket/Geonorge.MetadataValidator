...
{
	/// <summary>
	/// 	This class represents the Element TimeTopologyComplex
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TimeTopologyComplex", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TimeTopologyComplex : CSW.XmlCommonBase
					, AE.IAbstractTimeComplexType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TimeTopologyComplex
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TimeTopologyComplex";
			Init();
		}
		public TimeTopologyComplex(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TimeTopologyComplex newObject = new AE.TimeTopologyComplex(_elementName);
			newObject.m_Id = m_Id;
