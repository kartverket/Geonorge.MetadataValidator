...
{
	/// <summary>
	/// 	This class represents the Element pixelInCell
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"pixelInCell", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class PixelInCell : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PixelInCell
		/// </summary>
		/// <remarks>
		...
		public PixelInCell()
		{
			_elementName = "pixelInCell";
			Init();
		}
		public PixelInCell(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.PixelInCell newObject = new AE.PixelInCell(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element PixelInCell, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;PixelInCell&gt;Some Data&lt;/PixelInCell&gt;</BR>
		/// </remarks>
