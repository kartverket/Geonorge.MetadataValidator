...
{
	/// <summary>
	/// 	This class represents the Element GeometricComplex
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GeometricComplex", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GeometricComplex : CSW.XmlCommonBase
					, AE.IAbstractGeometryType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GeometricComplex
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "GeometricComplex";
			Init();
		}
		public GeometricComplex(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.GeometricComplex newObject = new AE.GeometricComplex(_elementName);
			newObject.m_Id = m_Id;
