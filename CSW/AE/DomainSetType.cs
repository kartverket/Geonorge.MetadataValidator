...
{
	/// <summary>
	/// 	This class represents the ComplexType DomainSetType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DomainSetType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DomainSetType : CSW.XmlCommonBase
					, AE.IDomainSetType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DomainSetType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DomainSetType";
			Init();
		}
		public DomainSetType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DomainSetType newObject = new AE.DomainSetType(_elementName);
