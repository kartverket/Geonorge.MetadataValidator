...
{
	/// <summary>
	/// 	This class represents the ComplexType PixelInCellType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PixelInCellType", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class PixelInCellType : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PixelInCellType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PixelInCellType";
			Init();
		}
		public PixelInCellType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.PixelInCellType newObject = new AE.PixelInCellType(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element PixelInCellType, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;PixelInCellType&gt;Some Data&lt;/PixelInCellType&gt;</BR>
		/// </remarks>
