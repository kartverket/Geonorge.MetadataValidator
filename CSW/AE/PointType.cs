...
{
	/// <summary>
	/// 	This class represents the ComplexType PointType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PointType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PointType : CSW.XmlCommonBase
					, AE.IAbstractGeometricPrimitiveType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PointType
		/// </summary>
		/// <remarks>
		...
		public PointType()
		{
			_elementName = "PointType";
			Init();
		}
		public PointType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_PointTypeData = new AE.PointType_Type("PointTypeData");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.PointType newObject = new AE.PointType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_PointTypeData = null;
			if (m_PointTypeData != null)
				newObject.m_PointTypeData = (AE.PointType_Type)m_PointTypeData.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - PointTypeData
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("PointTypeData", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.PointType_Type), false)]
		public AE.PointType_Type PointTypeData
		{
			get 
			{ 
				return m_PointTypeData;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "PointTypeData");
				m_PointTypeData = value;
			}
		}
		protected AE.PointType_Type m_PointTypeData;
