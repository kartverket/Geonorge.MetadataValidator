...
{
	/// <summary>
	/// 	This class represents the Element ImageDatum
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ImageDatum", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ImageDatum : CSW.XmlCommonBase
					, AE.IAbstractDatumType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ImageDatum
		/// </summary>
		/// <remarks>
		...
		public ImageDatum()
		{
			_elementName = "ImageDatum";
			Init();
		}
		public ImageDatum(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ImageDatum newObject = new AE.ImageDatum(_elementName);
			newObject.m_Id = m_Id;
