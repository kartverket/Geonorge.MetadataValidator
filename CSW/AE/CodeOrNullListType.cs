...
{
	/// <summary>
	/// 	This class represents the ComplexType CodeOrNullListType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CodeOrNullListType", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class CodeOrNullListType : CSW.XmlCommonBase
					, AE.ICodeOrNullListType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CodeOrNullListType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CodeOrNullListType";
			Init();
		}
		public CodeOrNullListType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CodeOrNullListType newObject = new AE.CodeOrNullListType(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element CodeOrNullListType, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;CodeOrNullListType&gt;Some Data&lt;/CodeOrNullListType&gt;</BR>
		/// </remarks>
