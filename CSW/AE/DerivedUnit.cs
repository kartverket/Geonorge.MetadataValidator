...
{
	/// <summary>
	/// 	This class represents the Element DerivedUnit
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DerivedUnit", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DerivedUnit : CSW.XmlCommonBase
					, AE.IUnitDefinitionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DerivedUnit
		/// </summary>
		/// <remarks>
		...
		public DerivedUnit()
		{
			_elementName = "DerivedUnit";
			Init();
		}
		public DerivedUnit(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DerivedUnit newObject = new AE.DerivedUnit(_elementName);
			newObject.m_Id = m_Id;
