...
{
	/// <summary>
	/// 	This class represents the ComplexType OperationParameterType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"OperationParameterType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class OperationParameterType : CSW.XmlCommonBase
					, AE.IOperationParameterBaseType
	{
		#region Constructors
		/// <summary>
		///		Constructor for OperationParameterType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "OperationParameterType";
			Init();
		}
		public OperationParameterType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.OperationParameterType newObject = new AE.OperationParameterType(_elementName);
			newObject.m_Id = m_Id;
