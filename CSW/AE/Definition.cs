...
{
	/// <summary>
	/// 	This class represents the Element Definition
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"Definition", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class Definition : CSW.XmlCommonBase
					, AE.IAbstractGMLType
					, AE.IDefinitionType
	{
		#region Constructors
		...
		public Definition()
		{
			_elementName = "Definition";
			Init();
		}
		public Definition(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.Definition newObject = new AE.Definition(_elementName);
			newObject.m_Id = m_Id;
