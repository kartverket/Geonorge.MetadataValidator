...
{
	/// <summary>
	/// 	This class represents the ComplexType MultiPointType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiPointType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiPointType : CSW.XmlCommonBase
					, AE.IAbstractGeometricAggregateType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiPointType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "MultiPointType";
			Init();
		}
		public MultiPointType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_PointMemberCol = new CSW.XmlObjectCollection<AE.PointMember>("pointMember", "http://www.opengis.net/gml", 0, -1, false);
			m_PointMembers = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiPointType newObject = new AE.MultiPointType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.PointMember o in m_PointMemberCol)
				newObject.m_PointMemberCol.Add((AE.PointMember)o.Clone());
			newObject.m_PointMembers = null;
			if (m_PointMembers != null)
				newObject.m_PointMembers = (AE.PointMembers)m_PointMembers.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - pointMember
		/// <summary>
		/// 	A collection of pointMemberCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// 	<BR>This collection may contain 0 to Many objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("pointMember", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.PointMember> PointMemberCol
		{
			get { return m_PointMemberCol; }
		}
		protected CSW.XmlObjectCollection<AE.PointMember> m_PointMemberCol;
		
		#endregion

		#region Attribute - pointMembers
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("pointMembers", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.PointMembers))]
		public AE.PointMembers PointMembers
		{
			get 
			{ 
				return m_PointMembers;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_PointMembers = value; 
				}
			}
		}
		protected AE.PointMembers m_PointMembers;
