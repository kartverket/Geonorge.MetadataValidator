...
{
	/// <summary>
	/// 	This class represents the ComplexType BagType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"BagType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class BagType : CSW.XmlCommonBase
					, AE.IAbstractGMLType
	{
		#region Constructors
		/// <summary>
		///		Constructor for BagType
		/// </summary>
		/// <remarks>
		...
		public BagType()
		{
			_elementName = "BagType";
			Init();
		}
		public BagType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_MemberCol = new CSW.XmlObjectCollection<AE.Member>("member", "http://www.opengis.net/gml", 0, -1, false);
			m_Members = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.BagType newObject = new AE.BagType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.Member o in m_MemberCol)
				newObject.m_MemberCol.Add((AE.Member)o.Clone());
			newObject.m_Members = null;
			if (m_Members != null)
				newObject.m_Members = (AE.Members)m_Members.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		public CSW.XmlObjectCollection<AE.Member> MemberCol
		{
			get { return m_MemberCol; }
		}
		protected CSW.XmlObjectCollection<AE.Member> m_MemberCol;
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("members", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.Members))]
		public AE.Members Members
		{
			get 
			{ 
				return m_Members;  
		...
		protected AE.Members m_Members;
