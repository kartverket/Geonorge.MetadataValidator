...
{
	/// <summary>
	/// 	This class represents the Element TemporalCRS
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TemporalCRS", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TemporalCRS : CSW.XmlCommonBase
					, AE.IAbstractReferenceSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TemporalCRS
		/// </summary>
		/// <remarks>
		...
		public TemporalCRS()
		{
			_elementName = "TemporalCRS";
			Init();
		}
		public TemporalCRS(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TemporalCRS newObject = new AE.TemporalCRS(_elementName);
			newObject.m_Id = m_Id;
