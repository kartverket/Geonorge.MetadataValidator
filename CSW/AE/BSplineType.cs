...
{
	/// <summary>
	/// 	This class represents the ComplexType BSplineType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"BSplineType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class BSplineType : CSW.XmlCommonBase
					, AE.IBSplineType
					, AE.IAbstractCurveSegmentType
	{
		#region Constructors
		/// <summary>
		///		Constructor for BSplineType
		/// </summary>
		/// <remarks>
		...
		public BSplineType()
		{
			_elementName = "BSplineType";
			Init();
		}
		public BSplineType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.BSplineType newObject = new AE.BSplineType(_elementName);
