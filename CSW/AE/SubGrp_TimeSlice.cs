...
{
	/// <summary>
	/// 	This class represents the Element SubGrp_TimeSlice
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"SubGrp_TimeSlice", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class SubGrp_TimeSlice : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for SubGrp_TimeSlice
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public SubGrp_TimeSlice()
		{
			_elementName = "SubGrp_TimeSlice";
			Init();
		}
		public SubGrp_TimeSlice(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.SubGrp_TimeSlice newObject = new AE.SubGrp_TimeSlice(_elementName);
