...
{
	/// <summary>
	/// 	This class represents the Element DirectedObservation
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DirectedObservation", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DirectedObservation : CSW.XmlCommonBase
					, AE.IObservationType
					, AE.IDirectedObservationType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DirectedObservation
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public DirectedObservation()
		{
			_elementName = "DirectedObservation";
			Init();
		}
		public DirectedObservation(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DirectedObservation newObject = new AE.DirectedObservation(_elementName);
			newObject.m_Id = m_Id;
