...
{
	/// <summary>
	/// 	This class represents the ComplexType SphereType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"SphereType", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class SphereType : CSW.XmlCommonBase
					, AE.IAbstractGriddedSurfaceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for SphereType
		/// </summary>
		/// <remarks>
		...
		public SphereType()
		{
			_elementName = "SphereType";
			Init();
		}
		public SphereType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.SphereType newObject = new AE.SphereType(_elementName);
