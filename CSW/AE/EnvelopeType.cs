...
{
	/// <summary>
	/// 	This class represents the ComplexType EnvelopeType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"EnvelopeType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class EnvelopeType : CSW.XmlCommonBase
					, AE.IEnvelopeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for EnvelopeType
		/// </summary>
		/// <remarks>
		...
		public EnvelopeType()
		{
			_elementName = "EnvelopeType";
			Init();
		}
		public EnvelopeType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.EnvelopeType newObject = new AE.EnvelopeType(_elementName);
