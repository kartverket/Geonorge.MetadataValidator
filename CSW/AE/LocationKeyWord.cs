...
{
	/// <summary>
	/// 	This class represents the Element LocationKeyWord
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"LocationKeyWord", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class LocationKeyWord : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for LocationKeyWord
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "LocationKeyWord";
			Init();
		}
		public LocationKeyWord(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.LocationKeyWord newObject = new AE.LocationKeyWord(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element LocationKeyWord, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;LocationKeyWord&gt;Some Data&lt;/LocationKeyWord&gt;</BR>
		/// </remarks>
