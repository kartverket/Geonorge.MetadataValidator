...
{
	/// <summary>
	/// 	This class represents the ComplexType AbstractSolidType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"AbstractSolidType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class AbstractSolidType : CSW.XmlCommonBase
					, AE.IAbstractSolidType
					, AE.IAbstractGeometricPrimitiveType
	{
		#region Constructors
		/// <summary>
		///		Constructor for AbstractSolidType
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public AbstractSolidType()
		{
			_elementName = "AbstractSolidType";
			Init();
		}
		public AbstractSolidType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.AbstractSolidType newObject = new AE.AbstractSolidType(_elementName);
			newObject.m_Id = m_Id;
