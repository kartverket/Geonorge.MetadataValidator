...
{
	/// <summary>
	/// 	This class represents the Element ConcatenatedOperation
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ConcatenatedOperation", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ConcatenatedOperation : CSW.XmlCommonBase
					, AE.IAbstractCoordinateOperationType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ConcatenatedOperation
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "ConcatenatedOperation";
			Init();
		}
		public ConcatenatedOperation(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ConcatenatedOperation newObject = new AE.ConcatenatedOperation(_elementName);
			newObject.m_Id = m_Id;
