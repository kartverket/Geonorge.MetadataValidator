...
{
	/// <summary>
	/// 	This class represents the ComplexType CircleByCenterPointType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CircleByCenterPointType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CircleByCenterPointType : CSW.XmlCommonBase
					, AE.IArcByCenterPointType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CircleByCenterPointType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CircleByCenterPointType";
			Init();
		}
		public CircleByCenterPointType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CircleByCenterPointType newObject = new AE.CircleByCenterPointType(_elementName);
