...
{
	/// <summary>
	/// 	This class represents the Element baseSurface
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"baseSurface", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class BaseSurface : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for BaseSurface
		/// </summary>
		/// <remarks>
		...
		public BaseSurface()
		{
			_elementName = "baseSurface";
			Init();
		}
		public BaseSurface(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.BaseSurface newObject = new AE.BaseSurface(_elementName);
			...
			newObject.m_BaseSurface_Group = null;
			if (m_BaseSurface_Group != null)
				newObject.m_BaseSurface_Group = (AE.BaseSurface_Group)m_BaseSurface_Group.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - baseSurface_Group
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("baseSurface_Group", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.BaseSurface_Group))]
		public AE.BaseSurface_Group BaseSurface_Group
		{
			get 
			{ 
				return m_BaseSurface_Group;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_BaseSurface_Group = value; 
				}
			}
		}
		protected AE.BaseSurface_Group m_BaseSurface_Group;
