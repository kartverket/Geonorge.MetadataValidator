...
{
	/// <summary>
	/// 	This class represents the ComplexType ProjectedCRSType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ProjectedCRSType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ProjectedCRSType : CSW.XmlCommonBase
					, AE.IAbstractGeneralDerivedCRSType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ProjectedCRSType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "ProjectedCRSType";
			Init();
		}
		public ProjectedCRSType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_UsesCartesianCS = new AE.UsesCartesianCS("usesCartesianCS");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ProjectedCRSType newObject = new AE.ProjectedCRSType(_elementName);
			newObject.m_Id = m_Id;
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		///		<BR>If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("usesCartesianCS", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.UsesCartesianCS), false)]
		public AE.UsesCartesianCS UsesCartesianCS
		{
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "usesCartesianCS");
