...
{
	/// <summary>
	/// 	This class represents the Element measureDescription
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"measureDescription", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class MeasureDescription : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MeasureDescription
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "measureDescription";
			Init();
		}
		public MeasureDescription(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MeasureDescription newObject = new AE.MeasureDescription(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element MeasureDescription, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;MeasureDescription&gt;Some Data&lt;/MeasureDescription&gt;</BR>
		/// </remarks>
