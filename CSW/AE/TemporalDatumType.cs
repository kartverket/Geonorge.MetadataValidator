...
{
	/// <summary>
	/// 	This class represents the ComplexType TemporalDatumType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TemporalDatumType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TemporalDatumType : CSW.XmlCommonBase
					, AE.ITemporalDatumBaseType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TemporalDatumType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TemporalDatumType";
			Init();
		}
		public TemporalDatumType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_Origin = new LiquidTechnologies.Runtime.Net45.XmlDateTime(LiquidTechnologies.Runtime.Net45.XmlDateTime.DateType.dateTime);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TemporalDatumType newObject = new AE.TemporalDatumType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_Origin = (LiquidTechnologies.Runtime.Net45.XmlDateTime)m_Origin.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimMnd("origin", "http://www.opengis.net/gml", null, LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_datetime, null, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Collapse, "", -1, -1, "", "", "", "", -1)]
		public LiquidTechnologies.Runtime.Net45.XmlDateTime Origin
		{
			get 
			{ 
				return m_Origin;  
			...
			set 
			{ 
				m_Origin.SetDateTime(value, m_Origin.Type); 
			}
		}
		protected LiquidTechnologies.Runtime.Net45.XmlDateTime m_Origin;
