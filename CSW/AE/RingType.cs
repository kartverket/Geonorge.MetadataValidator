...
{
	/// <summary>
	/// 	This class represents the ComplexType RingType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"RingType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class RingType : CSW.XmlCommonBase
					, AE.IAbstractRingType
	{
		#region Constructors
		/// <summary>
		///		Constructor for RingType
		/// </summary>
		/// <remarks>
		...
		public RingType()
		{
			_elementName = "RingType";
			Init();
		}
		public RingType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.RingType newObject = new AE.RingType(_elementName);
			newObject.m_Id = m_Id;
