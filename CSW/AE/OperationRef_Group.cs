...
{
	/// <summary>
	/// 	This class represents the Element operationRef_Group
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"operationRef_Group", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class OperationRef_Group : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for OperationRef_Group
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public OperationRef_Group()
		{
			_elementName = "operationRef_Group";
			Init();
		}
		public OperationRef_Group(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.OperationRef_Group newObject = new AE.OperationRef_Group(_elementName);
