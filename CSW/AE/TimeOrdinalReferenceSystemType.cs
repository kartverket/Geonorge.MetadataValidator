...
{
	/// <summary>
	/// 	This class represents the ComplexType TimeOrdinalReferenceSystemType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TimeOrdinalReferenceSystemType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TimeOrdinalReferenceSystemType : CSW.XmlCommonBase
					, AE.IAbstractTimeReferenceSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TimeOrdinalReferenceSystemType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TimeOrdinalReferenceSystemType";
			Init();
		}
		public TimeOrdinalReferenceSystemType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_ComponentCol = new CSW.XmlObjectCollection<AE.TimeOrdinalEraPropertyType>("component", "http://www.opengis.net/gml", 1, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TimeOrdinalReferenceSystemType newObject = new AE.TimeOrdinalReferenceSystemType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.TimeOrdinalEraPropertyType o in m_ComponentCol)
				newObject.m_ComponentCol.Add((AE.TimeOrdinalEraPropertyType)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - component
		/// <summary>
		/// 	A collection of componentCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("component", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.TimeOrdinalEraPropertyType> ComponentCol
		{
			get { return m_ComponentCol; }
		}
		protected CSW.XmlObjectCollection<AE.TimeOrdinalEraPropertyType> m_ComponentCol;
