...
{
	/// <summary>
	/// 	This class represents the Element MultiSurfaceCoverage
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiSurfaceCoverage", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiSurfaceCoverage : CSW.XmlCommonBase
					, AE.IAbstractDiscreteCoverageType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiSurfaceCoverage
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "MultiSurfaceCoverage";
			Init();
		}
		public MultiSurfaceCoverage(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiSurfaceCoverage newObject = new AE.MultiSurfaceCoverage(_elementName);
			newObject.m_Id = m_Id;
