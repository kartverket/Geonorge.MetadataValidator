...
{
	/// <summary>
	/// 	This class represents the Element TimeOrdinalReferenceSystem
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TimeOrdinalReferenceSystem", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TimeOrdinalReferenceSystem : CSW.XmlCommonBase
					, AE.IAbstractTimeReferenceSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TimeOrdinalReferenceSystem
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TimeOrdinalReferenceSystem";
			Init();
		}
		public TimeOrdinalReferenceSystem(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TimeOrdinalReferenceSystem newObject = new AE.TimeOrdinalReferenceSystem(_elementName);
			newObject.m_Id = m_Id;
