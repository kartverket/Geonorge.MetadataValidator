...
{
	/// <summary>
	/// 	This class represents the ComplexType CompositeValueType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CompositeValueType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CompositeValueType : CSW.XmlCommonBase
					, AE.ICompositeValueType
					, AE.IAbstractGMLType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CompositeValueType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CompositeValueType";
			Init();
		}
		public CompositeValueType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_ValueComponentCol = new CSW.XmlAbstractObjectCollection<AE.IValuePropertyType>("valueComponent", "http://www.opengis.net/gml", 0, -1, typeof(AE.ClassFactory), "IValuePropertyTypeCreateObject");
			m_ValueComponents = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CompositeValueType newObject = new AE.CompositeValueType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.IValuePropertyType o in m_ValueComponentCol)
				newObject.m_ValueComponentCol.Add((AE.IValuePropertyType)o.Clone());
			newObject.m_ValueComponents = null;
			if (m_ValueComponents != null)
				newObject.m_ValueComponents = (AE.ValueComponents)m_ValueComponents.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - valueComponent
		/// <summary>
		/// 	A collection of valueComponentCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// 	<BR>This collection may contain 0 to Many objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqAbsClsCol("valueComponent", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlAbstractObjectCollection<AE.IValuePropertyType> ValueComponentCol
		{
			get { return m_ValueComponentCol;  }
		}
		protected CSW.XmlAbstractObjectCollection<AE.IValuePropertyType> m_ValueComponentCol;
		
		#endregion

		#region Attribute - valueComponents
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("valueComponents", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.ValueComponents))]
		public AE.ValueComponents ValueComponents
		{
			get 
			{ 
				return m_ValueComponents;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_ValueComponents = value; 
				}
			}
		}
		protected AE.ValueComponents m_ValueComponents;
