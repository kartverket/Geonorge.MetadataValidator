...
{
	/// <summary>
	/// 	This class represents the ComplexType DerivedCRSTypeType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DerivedCRSTypeType", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class DerivedCRSTypeType : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DerivedCRSTypeType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DerivedCRSTypeType";
			Init();
		}
		public DerivedCRSTypeType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DerivedCRSTypeType newObject = new AE.DerivedCRSTypeType(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element DerivedCRSTypeType, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;DerivedCRSTypeType&gt;Some Data&lt;/DerivedCRSTypeType&gt;</BR>
		/// </remarks>
