...
{
	/// <summary>
	/// 	This class represents the Element usesGeodeticDatum
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"usesGeodeticDatum", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class UsesGeodeticDatum : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for UsesGeodeticDatum
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public UsesGeodeticDatum()
		{
			_elementName = "usesGeodeticDatum";
			Init();
		}
		public UsesGeodeticDatum(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_UsesGeodeticDatum_Group = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.UsesGeodeticDatum newObject = new AE.UsesGeodeticDatum(_elementName);
			...
			newObject.m_UsesGeodeticDatum_Group = null;
			if (m_UsesGeodeticDatum_Group != null)
				newObject.m_UsesGeodeticDatum_Group = (AE.UsesGeodeticDatum_Group)m_UsesGeodeticDatum_Group.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - usesGeodeticDatum_Group
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("usesGeodeticDatum_Group", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.UsesGeodeticDatum_Group))]
		public AE.UsesGeodeticDatum_Group UsesGeodeticDatum_Group
		{
			get 
			{ 
				return m_UsesGeodeticDatum_Group;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_UsesGeodeticDatum_Group = value; 
				}
			}
		}
		protected AE.UsesGeodeticDatum_Group m_UsesGeodeticDatum_Group;
