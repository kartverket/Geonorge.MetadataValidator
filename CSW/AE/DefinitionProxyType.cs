...
{
	/// <summary>
	/// 	This class represents the ComplexType DefinitionProxyType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DefinitionProxyType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DefinitionProxyType : CSW.XmlCommonBase
					, AE.IDefinitionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DefinitionProxyType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DefinitionProxyType";
			Init();
		}
		public DefinitionProxyType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_DefinitionRef = new AE.DefinitionRef("definitionRef");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DefinitionProxyType newObject = new AE.DefinitionProxyType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_DefinitionRef = null;
			if (m_DefinitionRef != null)
				newObject.m_DefinitionRef = (AE.DefinitionRef)m_DefinitionRef.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - definitionRef
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("definitionRef", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.DefinitionRef), false)]
		public AE.DefinitionRef DefinitionRef
		{
			get 
			{ 
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "definitionRef");
				m_DefinitionRef = value;
			}
		}
		protected AE.DefinitionRef m_DefinitionRef;
