...
{
	/// <summary>
	/// 	This class represents the abstract Element I_CoordinateReferenceSystem
	/// </summary>
	/// <remarks>
	/// </remarks>
	public interface I_CoordinateReferenceSystem : LiquidTechnologies.Runtime.Net45.XmlObjectInterface
