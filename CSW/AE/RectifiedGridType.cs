...
{
	/// <summary>
	/// 	This class represents the ComplexType RectifiedGridType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"RectifiedGridType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class RectifiedGridType : CSW.XmlCommonBase
					, AE.IGridType
	{
		#region Constructors
		/// <summary>
		///		Constructor for RectifiedGridType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "RectifiedGridType";
			Init();
		}
		public RectifiedGridType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_Dimension = 0;
			m_Limits = new AE.GridLimitsType("limits");
			m_AxisNameCol = new CSW.XmlSimpleTypeCollection<String>("axisName", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, 1, -1, null, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Preserve, new LiquidTechnologies.Runtime.Net45.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1));
			m_Origin = new AE.PointPropertyType("origin");
			m_OffsetVectorCol = new CSW.XmlObjectCollection<AE.VectorType>("offsetVector", "http://www.opengis.net/gml", 1, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.RectifiedGridType newObject = new AE.RectifiedGridType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_Limits = null;
			if (m_Limits != null)
				newObject.m_Limits = (AE.GridLimitsType)m_Limits.Clone();
			foreach (String o in m_AxisNameCol)
				newObject.m_AxisNameCol.Add(o);
			newObject.m_Origin = null;
			if (m_Origin != null)
				newObject.m_Origin = (AE.PointPropertyType)m_Origin.Clone();
			foreach (AE.VectorType o in m_OffsetVectorCol)
				newObject.m_OffsetVectorCol.Add((AE.VectorType)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.AttributeInfoPrimitive("dimension", "", LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_integer, null, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Collapse, null, "", -1, -1, "", "", "", "", -1)]
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("limits", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.GridLimitsType), true)]
		public AE.GridLimitsType Limits
		{
			get 
			{ 
				return m_Limits;  
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "limits");
				if (value != null)
					SetElementName(value, "limits");
				m_Limits = value;
			}
		}
		protected AE.GridLimitsType m_Limits;
		
		#endregion

		#region Attribute - axisName
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimCol("axisName", "http://www.opengis.net/gml")]
		public CSW.XmlSimpleTypeCollection<String> AxisNameCol
		{
			get { return m_AxisNameCol; }
		}
		protected CSW.XmlSimpleTypeCollection<String> m_AxisNameCol;
		...
		///		<BR>If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("origin", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.PointPropertyType), false)]
		public AE.PointPropertyType Origin
		{
			get 
			{ 
				return m_Origin;  
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "origin");
				if (value != null)
					SetElementName(value, "origin");
				m_Origin = value;
			}
		}
		protected AE.PointPropertyType m_Origin;
		
		#endregion

		#region Attribute - offsetVector
		/// <summary>
		/// 	A collection of offsetVectorCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("offsetVector", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.VectorType> OffsetVectorCol
		{
			get { return m_OffsetVectorCol; }
		}
		protected CSW.XmlObjectCollection<AE.VectorType> m_OffsetVectorCol;
