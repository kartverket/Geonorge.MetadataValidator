...
{
	/// <summary>
	/// 	This class represents the Element abstractGeneralOperationParameterRef
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"abstractGeneralOperationParameterRef", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class AbstractGeneralOperationParameterRef : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for AbstractGeneralOperationParameterRef
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public AbstractGeneralOperationParameterRef()
		{
			_elementName = "abstractGeneralOperationParameterRef";
			Init();
		}
		public AbstractGeneralOperationParameterRef(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_AbstractGeneralOperationParameterRef_Group = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.AbstractGeneralOperationParameterRef newObject = new AE.AbstractGeneralOperationParameterRef(_elementName);
			...
			newObject.m_AbstractGeneralOperationParameterRef_Group = null;
			if (m_AbstractGeneralOperationParameterRef_Group != null)
				newObject.m_AbstractGeneralOperationParameterRef_Group = (AE.AbstractGeneralOperationParameterRef_Group)m_AbstractGeneralOperationParameterRef_Group.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - abstractGeneralOperationParameterRef_Group
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("abstractGeneralOperationParameterRef_Group", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.AbstractGeneralOperationParameterRef_Group))]
		public AE.AbstractGeneralOperationParameterRef_Group AbstractGeneralOperationParameterRef_Group
		{
			get 
			{ 
				return m_AbstractGeneralOperationParameterRef_Group;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_AbstractGeneralOperationParameterRef_Group = value; 
				}
			}
		}
		protected AE.AbstractGeneralOperationParameterRef_Group m_AbstractGeneralOperationParameterRef_Group;
