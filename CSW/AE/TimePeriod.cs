...
{
	/// <summary>
	/// 	This class represents the Element TimePeriod
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TimePeriod", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TimePeriod : CSW.XmlCommonBase
					, AE.IAbstractTimeGeometricPrimitiveType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TimePeriod
		/// </summary>
		/// <remarks>
		...
		public TimePeriod()
		{
			_elementName = "TimePeriod";
			Init();
		}
		public TimePeriod(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TimePeriod newObject = new AE.TimePeriod(_elementName);
			newObject.m_Id = m_Id;
