...
{
	/// <summary>
	/// 	This class represents the ComplexType RelativeInternalPositionalAccuracyType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"RelativeInternalPositionalAccuracyType", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class RelativeInternalPositionalAccuracyType : CSW.XmlCommonBase
					, AE.IAbstractPositionalAccuracyType
	{
		#region Constructors
		/// <summary>
		///		Constructor for RelativeInternalPositionalAccuracyType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "RelativeInternalPositionalAccuracyType";
			Init();
		}
		public RelativeInternalPositionalAccuracyType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.RelativeInternalPositionalAccuracyType newObject = new AE.RelativeInternalPositionalAccuracyType(_elementName);
