...
{
	/// <summary>
	/// 	This class represents the ComplexType ObservationType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ObservationType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ObservationType : CSW.XmlCommonBase
					, AE.IObservationType
					, AE.IAbstractFeatureType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ObservationType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "ObservationType";
			Init();
		}
		public ObservationType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ObservationType newObject = new AE.ObservationType(_elementName);
			newObject.m_Id = m_Id;
