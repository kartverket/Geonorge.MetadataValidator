...
{
	/// <summary>
	/// 	This class represents the Element GridCoverage
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GridCoverage", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GridCoverage : CSW.XmlCommonBase
					, AE.IAbstractDiscreteCoverageType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GridCoverage
		/// </summary>
		/// <remarks>
		...
		public GridCoverage()
		{
			_elementName = "GridCoverage";
			Init();
		}
		public GridCoverage(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.GridCoverage newObject = new AE.GridCoverage(_elementName);
			newObject.m_Id = m_Id;
