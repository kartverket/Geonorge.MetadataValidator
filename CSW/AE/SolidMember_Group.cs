...
{
	/// <summary>
	/// 	This class represents the Element solidMember_Group
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"solidMember_Group", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class SolidMember_Group : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for SolidMember_Group
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public SolidMember_Group()
		{
			_elementName = "solidMember_Group";
			Init();
		}
		public SolidMember_Group(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.SolidMember_Group newObject = new AE.SolidMember_Group(_elementName);
