...
{
	/// <summary>
	/// 	This class represents the Element TopoSolid
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TopoSolid", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TopoSolid : CSW.XmlCommonBase
					, AE.IAbstractTopoPrimitiveType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TopoSolid
		/// </summary>
		/// <remarks>
		...
		public TopoSolid()
		{
			_elementName = "TopoSolid";
			Init();
		}
		public TopoSolid(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_Container = null;
			m_DirectedFaceCol = new CSW.XmlObjectCollection<AE.DirectedFace>("directedFace", "http://www.opengis.net/gml", 1, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TopoSolid newObject = new AE.TopoSolid(_elementName);
			newObject.m_Id = m_Id;
