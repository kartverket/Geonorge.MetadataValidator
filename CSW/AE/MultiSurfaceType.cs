...
{
	/// <summary>
	/// 	This class represents the ComplexType MultiSurfaceType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiSurfaceType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiSurfaceType : CSW.XmlCommonBase
					, AE.IAbstractGeometricAggregateType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiSurfaceType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "MultiSurfaceType";
			Init();
		}
		public MultiSurfaceType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_SurfaceMemberCol = new CSW.XmlObjectCollection<AE.SurfaceMember>("surfaceMember", "http://www.opengis.net/gml", 0, -1, false);
			m_SurfaceMembers = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiSurfaceType newObject = new AE.MultiSurfaceType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.SurfaceMember o in m_SurfaceMemberCol)
				newObject.m_SurfaceMemberCol.Add((AE.SurfaceMember)o.Clone());
			newObject.m_SurfaceMembers = null;
			if (m_SurfaceMembers != null)
				newObject.m_SurfaceMembers = (AE.SurfaceMembers)m_SurfaceMembers.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - surfaceMember
		/// <summary>
		/// 	A collection of surfaceMemberCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// 	<BR>This collection may contain 0 to Many objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("surfaceMember", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.SurfaceMember> SurfaceMemberCol
		{
			get { return m_SurfaceMemberCol; }
		}
		protected CSW.XmlObjectCollection<AE.SurfaceMember> m_SurfaceMemberCol;
		
		#endregion

		#region Attribute - surfaceMembers
		/// <summary>
		///		Represents an optional Element in the XML document
		/// 	
		/// </summary>
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("surfaceMembers", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.SurfaceMembers))]
		public AE.SurfaceMembers SurfaceMembers
		{
			get 
			{ 
				return m_SurfaceMembers;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_SurfaceMembers = value; 
				}
			}
		}
		protected AE.SurfaceMembers m_SurfaceMembers;
