...
{
	/// <summary>
	/// 	This class represents the ComplexType GridCoverageType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GridCoverageType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GridCoverageType : CSW.XmlCommonBase
					, AE.IAbstractDiscreteCoverageType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GridCoverageType
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public GridCoverageType()
		{
			_elementName = "GridCoverageType";
			Init();
		}
		public GridCoverageType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.GridCoverageType newObject = new AE.GridCoverageType(_elementName);
			newObject.m_Id = m_Id;
