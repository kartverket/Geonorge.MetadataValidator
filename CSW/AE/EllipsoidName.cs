...
{
	/// <summary>
	/// 	This class represents the Element ellipsoidName
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ellipsoidName", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class EllipsoidName : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for EllipsoidName
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public EllipsoidName()
		{
			_elementName = "ellipsoidName";
			Init();
		}
		public EllipsoidName(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.EllipsoidName newObject = new AE.EllipsoidName(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element EllipsoidName, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;EllipsoidName&gt;Some Data&lt;/EllipsoidName&gt;</BR>
		/// </remarks>
