...
{
	/// <summary>
	/// 	This class represents the ComplexType TransformationType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TransformationType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TransformationType : CSW.XmlCommonBase
					, AE.IAbstractGeneralTransformationType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TransformationType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TransformationType";
			Init();
		}
		public TransformationType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TransformationType newObject = new AE.TransformationType(_elementName);
			newObject.m_Id = m_Id;
