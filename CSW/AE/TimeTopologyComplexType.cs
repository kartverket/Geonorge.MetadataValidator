...
{
	/// <summary>
	/// 	This class represents the ComplexType TimeTopologyComplexType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TimeTopologyComplexType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TimeTopologyComplexType : CSW.XmlCommonBase
					, AE.IAbstractTimeComplexType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TimeTopologyComplexType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TimeTopologyComplexType";
			Init();
		}
		public TimeTopologyComplexType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_PrimitiveCol = new CSW.XmlObjectCollection<AE.TimeTopologyPrimitivePropertyType>("primitive", "http://www.opengis.net/gml", 1, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TimeTopologyComplexType newObject = new AE.TimeTopologyComplexType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.TimeTopologyPrimitivePropertyType o in m_PrimitiveCol)
				newObject.m_PrimitiveCol.Add((AE.TimeTopologyPrimitivePropertyType)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - primitive
		/// <summary>
		/// 	A collection of primitiveCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("primitive", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.TimeTopologyPrimitivePropertyType> PrimitiveCol
		{
			get { return m_PrimitiveCol; }
		}
		protected CSW.XmlObjectCollection<AE.TimeTopologyPrimitivePropertyType> m_PrimitiveCol;
