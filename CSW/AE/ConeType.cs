...
{
	/// <summary>
	/// 	This class represents the ComplexType ConeType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ConeType", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ConeType : CSW.XmlCommonBase
					, AE.IAbstractGriddedSurfaceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ConeType
		/// </summary>
		/// <remarks>
		...
		public ConeType()
		{
			_elementName = "ConeType";
			Init();
		}
		public ConeType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ConeType newObject = new AE.ConeType(_elementName);
