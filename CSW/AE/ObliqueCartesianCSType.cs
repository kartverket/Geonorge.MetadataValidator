...
{
	/// <summary>
	/// 	This class represents the ComplexType ObliqueCartesianCSType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"ObliqueCartesianCSType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ObliqueCartesianCSType : CSW.XmlCommonBase
					, AE.IAbstractCoordinateSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for ObliqueCartesianCSType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "ObliqueCartesianCSType";
			Init();
		}
		public ObliqueCartesianCSType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ObliqueCartesianCSType newObject = new AE.ObliqueCartesianCSType(_elementName);
			newObject.m_Id = m_Id;
