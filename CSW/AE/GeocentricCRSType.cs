...
{
	/// <summary>
	/// 	This class represents the ComplexType GeocentricCRSType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GeocentricCRSType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GeocentricCRSType : CSW.XmlCommonBase
					, AE.IAbstractReferenceSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GeocentricCRSType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "GeocentricCRSType";
			Init();
		}
		public GeocentricCRSType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_GeocentricCRSType_Type_Seq_Choice = new AE.GeocentricCRSType_Type_Seq_Choice("GeocentricCRSType_Type_Seq_Choice");
			m_UsesGeodeticDatum = new AE.UsesGeodeticDatum("usesGeodeticDatum");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.GeocentricCRSType newObject = new AE.GeocentricCRSType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_GeocentricCRSType_Type_Seq_Choice = null;
			if (m_GeocentricCRSType_Type_Seq_Choice != null)
				newObject.m_GeocentricCRSType_Type_Seq_Choice = (AE.GeocentricCRSType_Type_Seq_Choice)m_GeocentricCRSType_Type_Seq_Choice.Clone();
			newObject.m_UsesGeodeticDatum = null;
			if (m_UsesGeodeticDatum != null)
				newObject.m_UsesGeodeticDatum = (AE.UsesGeodeticDatum)m_UsesGeodeticDatum.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - GeocentricCRSType_Type_Seq_Choice
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("GeocentricCRSType_Type_Seq_Choice", "", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.GeocentricCRSType_Type_Seq_Choice), false)]
		public AE.GeocentricCRSType_Type_Seq_Choice GeocentricCRSType_Type_Seq_Choice
		{
			get 
			{ 
				return m_GeocentricCRSType_Type_Seq_Choice;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "GeocentricCRSType_Type_Seq_Choice");
				m_GeocentricCRSType_Type_Seq_Choice = value;
			}
		}
		protected AE.GeocentricCRSType_Type_Seq_Choice m_GeocentricCRSType_Type_Seq_Choice;
		
		#endregion

		#region Attribute - usesGeodeticDatum
		/// <summary>
		///		Represents a mandatory Element in the XML document
		/// 	
		/// </summary>
		...
		///		<BR>If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("usesGeodeticDatum", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.UsesGeodeticDatum), false)]
		public AE.UsesGeodeticDatum UsesGeodeticDatum
		{
			get 
			{ 
				return m_UsesGeodeticDatum;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "usesGeodeticDatum");
				m_UsesGeodeticDatum = value;
			}
		}
		protected AE.UsesGeodeticDatum m_UsesGeodeticDatum;
