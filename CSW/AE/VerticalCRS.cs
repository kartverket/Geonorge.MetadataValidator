...
{
	/// <summary>
	/// 	This class represents the Element VerticalCRS
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"VerticalCRS", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class VerticalCRS : CSW.XmlCommonBase
					, AE.IAbstractReferenceSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for VerticalCRS
		/// </summary>
		/// <remarks>
		...
		public VerticalCRS()
		{
			_elementName = "VerticalCRS";
			Init();
		}
		public VerticalCRS(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.VerticalCRS newObject = new AE.VerticalCRS(_elementName);
			newObject.m_Id = m_Id;
