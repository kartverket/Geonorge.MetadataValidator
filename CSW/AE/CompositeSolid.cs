...
{
	/// <summary>
	/// 	This class represents the Element CompositeSolid
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CompositeSolid", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CompositeSolid : CSW.XmlCommonBase
					, AE.IAbstractSolidType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CompositeSolid
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CompositeSolid";
			Init();
		}
		public CompositeSolid(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CompositeSolid newObject = new AE.CompositeSolid(_elementName);
			newObject.m_Id = m_Id;
