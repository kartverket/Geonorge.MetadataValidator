...
{
	/// <summary>
	/// 	This class represents the ComplexType MultiPolygonType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiPolygonType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiPolygonType : CSW.XmlCommonBase
					, AE.IAbstractGeometricAggregateType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiPolygonType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "MultiPolygonType";
			Init();
		}
		public MultiPolygonType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_PolygonMemberCol = new CSW.XmlObjectCollection<AE.PolygonMember>("polygonMember", "http://www.opengis.net/gml", 0, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiPolygonType newObject = new AE.MultiPolygonType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.PolygonMember o in m_PolygonMemberCol)
				newObject.m_PolygonMemberCol.Add((AE.PolygonMember)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - polygonMember
		/// <summary>
		/// 	A collection of polygonMemberCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// 	<BR>This collection may contain 0 to Many objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("polygonMember", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.PolygonMember> PolygonMemberCol
		{
			get { return m_PolygonMemberCol; }
		}
		protected CSW.XmlObjectCollection<AE.PolygonMember> m_PolygonMemberCol;
