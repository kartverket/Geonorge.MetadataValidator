...
{
	/// <summary>
	/// 	This class represents the ComplexType TinType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TinType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TinType : CSW.XmlCommonBase
					, AE.ITriangulatedSurfaceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TinType
		/// </summary>
		/// <remarks>
		...
		public TinType()
		{
			_elementName = "TinType";
			Init();
		}
		public TinType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_SurfaceTypeData = new AE.SurfaceType_Type("SurfaceTypeData");
			m_StopLinesCol = new CSW.XmlObjectCollection<AE.LineStringSegmentArrayPropertyType>("stopLines", "http://www.opengis.net/gml", 0, -1, false);
			m_BreakLinesCol = new CSW.XmlObjectCollection<AE.LineStringSegmentArrayPropertyType>("breakLines", "http://www.opengis.net/gml", 0, -1, false);
			m_MaxLength = new AE.LengthType("maxLength");
			m_ControlPoint = new AE.ControlPoint("controlPoint");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TinType newObject = new AE.TinType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_SurfaceTypeData = null;
			if (m_SurfaceTypeData != null)
				newObject.m_SurfaceTypeData = (AE.SurfaceType_Type)m_SurfaceTypeData.Clone();
			foreach (AE.LineStringSegmentArrayPropertyType o in m_StopLinesCol)
				newObject.m_StopLinesCol.Add((AE.LineStringSegmentArrayPropertyType)o.Clone());
			foreach (AE.LineStringSegmentArrayPropertyType o in m_BreakLinesCol)
				newObject.m_BreakLinesCol.Add((AE.LineStringSegmentArrayPropertyType)o.Clone());
			newObject.m_MaxLength = null;
			if (m_MaxLength != null)
				newObject.m_MaxLength = (AE.LengthType)m_MaxLength.Clone();
			newObject.m_ControlPoint = null;
			if (m_ControlPoint != null)
				newObject.m_ControlPoint = (AE.ControlPoint)m_ControlPoint.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - SurfaceTypeData
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("SurfaceTypeData", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.SurfaceType_Type), false)]
		public AE.SurfaceType_Type SurfaceTypeData
		{
			get 
			{ 
				return m_SurfaceTypeData;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "SurfaceTypeData");
				m_SurfaceTypeData = value;
			}
		}
		protected AE.SurfaceType_Type m_SurfaceTypeData;
		
		#endregion

		#region Attribute - stopLines
		/// <summary>
		/// 	A collection of stopLinesCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// 	<BR>This collection may contain 0 to Many objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("stopLines", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.LineStringSegmentArrayPropertyType> StopLinesCol
		{
			get { return m_StopLinesCol; }
		}
		protected CSW.XmlObjectCollection<AE.LineStringSegmentArrayPropertyType> m_StopLinesCol;
		
		#endregion

		#region Attribute - breakLines
		/// <summary>
		/// 	A collection of breakLinesCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// 	<BR>This collection may contain 0 to Many objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("breakLines", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.LineStringSegmentArrayPropertyType> BreakLinesCol
		{
			get { return m_BreakLinesCol; }
		}
		protected CSW.XmlObjectCollection<AE.LineStringSegmentArrayPropertyType> m_BreakLinesCol;
		
		#endregion

		#region Attribute - maxLength
		/// <summary>
		///		Represents a mandatory Element in the XML document
		/// 	
		/// </summary>
		...
		///		<BR>If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("maxLength", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.LengthType), false)]
		public AE.LengthType MaxLength
		{
			get 
			{ 
				return m_MaxLength;  
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "maxLength");
				if (value != null)
					SetElementName(value, "maxLength");
				m_MaxLength = value;
			}
		}
		protected AE.LengthType m_MaxLength;
		
		#endregion

		#region Attribute - controlPoint
		/// <summary>
		///		Represents a mandatory Element in the XML document
		/// 	
		/// </summary>
		...
		///		<BR>If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("controlPoint", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.ControlPoint), true)]
		public AE.ControlPoint ControlPoint
		{
			get 
			{ 
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "controlPoint");
				if (value != null)
					SetElementName(value, "controlPoint");
				m_ControlPoint = value;
			}
		}
		protected AE.ControlPoint m_ControlPoint;
