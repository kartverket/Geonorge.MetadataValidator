...
{
	/// <summary>
	/// 	This class represents the Element TimeCalendarEra
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TimeCalendarEra", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TimeCalendarEra : CSW.XmlCommonBase
					, AE.IDefinitionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TimeCalendarEra
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TimeCalendarEra";
			Init();
		}
		public TimeCalendarEra(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TimeCalendarEra newObject = new AE.TimeCalendarEra(_elementName);
			newObject.m_Id = m_Id;
