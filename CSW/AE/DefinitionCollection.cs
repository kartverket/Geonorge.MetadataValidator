...
{
	/// <summary>
	/// 	This class represents the Element DefinitionCollection
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DefinitionCollection", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DefinitionCollection : CSW.XmlCommonBase
					, AE.IDefinitionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DefinitionCollection
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DefinitionCollection";
			Init();
		}
		public DefinitionCollection(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_DictionaryType_Type_SeqCol = new CSW.XmlObjectCollection<AE.DictionaryType_Type_Seq>("DictionaryType_Type_Seq", "", 0, -1, true);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DefinitionCollection newObject = new AE.DefinitionCollection(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.DictionaryType_Type_Seq o in m_DictionaryType_Type_SeqCol)
				newObject.m_DictionaryType_Type_SeqCol.Add((AE.DictionaryType_Type_Seq)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - DictionaryType_Type_Seq
		/// <summary>
		/// 	A collection of DictionaryType_Type_SeqCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// 	<BR>This collection may contain 0 to Many objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("DictionaryType_Type_Seq", "", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement)]
		public CSW.XmlObjectCollection<AE.DictionaryType_Type_Seq> DictionaryType_Type_SeqCol
		{
			get { return m_DictionaryType_Type_SeqCol; }
		}
		protected CSW.XmlObjectCollection<AE.DictionaryType_Type_Seq> m_DictionaryType_Type_SeqCol;
