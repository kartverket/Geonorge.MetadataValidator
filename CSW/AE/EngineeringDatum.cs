...
{
	/// <summary>
	/// 	This class represents the Element EngineeringDatum
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"EngineeringDatum", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class EngineeringDatum : CSW.XmlCommonBase
					, AE.IAbstractDatumType
	{
		#region Constructors
		/// <summary>
		///		Constructor for EngineeringDatum
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "EngineeringDatum";
			Init();
		}
		public EngineeringDatum(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.EngineeringDatum newObject = new AE.EngineeringDatum(_elementName);
			newObject.m_Id = m_Id;
