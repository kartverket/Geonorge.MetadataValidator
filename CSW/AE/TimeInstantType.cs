...
{
	/// <summary>
	/// 	This class represents the ComplexType TimeInstantType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"TimeInstantType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class TimeInstantType : CSW.XmlCommonBase
					, AE.IAbstractTimeGeometricPrimitiveType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TimeInstantType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TimeInstantType";
			Init();
		}
		public TimeInstantType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_IsValidFrame = true;
			m_TimePosition = new AE.TimePosition("timePosition");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.TimeInstantType newObject = new AE.TimeInstantType(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_TimePosition = null;
			if (m_TimePosition != null)
				newObject.m_TimePosition = (AE.TimePosition)m_TimePosition.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("timePosition", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.TimePosition), false)]
		public AE.TimePosition TimePosition
		{
			get 
			{ 
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "timePosition");
				m_TimePosition = value;
			}
		}
		protected AE.TimePosition m_TimePosition;
