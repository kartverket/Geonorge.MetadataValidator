...
{
	/// <summary>
	/// 	This class represents the Element anchorPoint
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"anchorPoint", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class AnchorPoint : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for AnchorPoint
		/// </summary>
		/// <remarks>
		...
		public AnchorPoint()
		{
			_elementName = "anchorPoint";
			Init();
		}
		public AnchorPoint(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.AnchorPoint newObject = new AE.AnchorPoint(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element AnchorPoint, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;AnchorPoint&gt;Some Data&lt;/AnchorPoint&gt;</BR>
		/// </remarks>
