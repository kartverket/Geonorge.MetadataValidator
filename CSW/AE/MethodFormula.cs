...
{
	/// <summary>
	/// 	This class represents the Element methodFormula
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"methodFormula", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class MethodFormula : CSW.XmlCommonBase
					, AE.ICodeType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MethodFormula
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "methodFormula";
			Init();
		}
		public MethodFormula(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MethodFormula newObject = new AE.MethodFormula(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element MethodFormula, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;MethodFormula&gt;Some Data&lt;/MethodFormula&gt;</BR>
		/// </remarks>
