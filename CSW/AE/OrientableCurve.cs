...
{
	/// <summary>
	/// 	This class represents the Element OrientableCurve
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"OrientableCurve", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class OrientableCurve : CSW.XmlCommonBase
					, AE.IAbstractCurveType
	{
		#region Constructors
		/// <summary>
		///		Constructor for OrientableCurve
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "OrientableCurve";
			Init();
		}
		public OrientableCurve(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.OrientableCurve newObject = new AE.OrientableCurve(_elementName);
			newObject.m_Id = m_Id;
