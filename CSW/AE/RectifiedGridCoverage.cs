...
{
	/// <summary>
	/// 	This class represents the Element RectifiedGridCoverage
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"RectifiedGridCoverage", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class RectifiedGridCoverage : CSW.XmlCommonBase
					, AE.IAbstractDiscreteCoverageType
	{
		#region Constructors
		/// <summary>
		///		Constructor for RectifiedGridCoverage
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "RectifiedGridCoverage";
			Init();
		}
		public RectifiedGridCoverage(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.RectifiedGridCoverage newObject = new AE.RectifiedGridCoverage(_elementName);
			newObject.m_Id = m_Id;
