...
{
	/// <summary>
	/// 	This class represents the ComplexType CylinderType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CylinderType", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CylinderType : CSW.XmlCommonBase
					, AE.IAbstractGriddedSurfaceType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CylinderType
		/// </summary>
		/// <remarks>
		...
		public CylinderType()
		{
			_elementName = "CylinderType";
			Init();
		}
		public CylinderType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CylinderType newObject = new AE.CylinderType(_elementName);
