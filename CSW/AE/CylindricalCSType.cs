...
{
	/// <summary>
	/// 	This class represents the ComplexType CylindricalCSType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CylindricalCSType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class CylindricalCSType : CSW.XmlCommonBase
					, AE.IAbstractCoordinateSystemType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CylindricalCSType
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public CylindricalCSType()
		{
			_elementName = "CylindricalCSType";
			Init();
		}
		public CylindricalCSType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CylindricalCSType newObject = new AE.CylindricalCSType(_elementName);
			newObject.m_Id = m_Id;
