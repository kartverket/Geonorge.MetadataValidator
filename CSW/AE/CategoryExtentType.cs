...
{
	/// <summary>
	/// 	This class represents the ComplexType CategoryExtentType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"CategoryExtentType", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class CategoryExtentType : CSW.XmlCommonBase
					, AE.ICodeOrNullListType
	{
		#region Constructors
		/// <summary>
		///		Constructor for CategoryExtentType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "CategoryExtentType";
			Init();
		}
		public CategoryExtentType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.CategoryExtentType newObject = new AE.CategoryExtentType(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element CategoryExtentType, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;CategoryExtentType&gt;Some Data&lt;/CategoryExtentType&gt;</BR>
		/// </remarks>
