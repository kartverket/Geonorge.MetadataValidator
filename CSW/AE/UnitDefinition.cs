...
{
	/// <summary>
	/// 	This class represents the Element UnitDefinition
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"UnitDefinition", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class UnitDefinition : CSW.XmlCommonBase
					, AE.IDefinitionType
					, AE.IUnitDefinitionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for UnitDefinition
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "UnitDefinition";
			Init();
		}
		public UnitDefinition(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.UnitDefinition newObject = new AE.UnitDefinition(_elementName);
			newObject.m_Id = m_Id;
