...
{
	/// <summary>
	/// 	This class represents the Element EnvelopeWithTimePeriodType_Type
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"EnvelopeWithTimePeriodType_Type", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class EnvelopeWithTimePeriodType_Type : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for EnvelopeWithTimePeriodType_Type
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public EnvelopeWithTimePeriodType_Type()
		{
			_elementName = "EnvelopeWithTimePeriodType_Type";
			Init();
		}
		public EnvelopeWithTimePeriodType_Type(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_IsValidFrame = true;
			m_TimePositionCol = new CSW.XmlObjectCollection<AE.TimePosition>("timePosition", "http://www.opengis.net/gml", 2, 2, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.EnvelopeWithTimePeriodType_Type newObject = new AE.EnvelopeWithTimePeriodType_Type(_elementName);
			newObject.m_Frame = m_Frame;
			newObject.m_IsValidFrame = m_IsValidFrame;
			foreach (AE.TimePosition o in m_TimePositionCol)
				newObject.m_TimePositionCol.Add((AE.TimePosition)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// <summary>
		/// 	A collection of timePositionCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("timePosition", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.TimePosition> TimePositionCol
		{
			get { return m_TimePositionCol; }
		}
		protected CSW.XmlObjectCollection<AE.TimePosition> m_TimePositionCol;
