...
{
	/// <summary>
	/// 	This class represents the ComplexType DictionaryType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DictionaryType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DictionaryType : CSW.XmlCommonBase
					, AE.IDefinitionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DictionaryType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DictionaryType";
			Init();
		}
		public DictionaryType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.DictionaryType newObject = new AE.DictionaryType(_elementName);
			newObject.m_Id = m_Id;
