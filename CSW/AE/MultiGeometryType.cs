...
{
	/// <summary>
	/// 	This class represents the ComplexType MultiGeometryType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"MultiGeometryType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiGeometryType : CSW.XmlCommonBase
					, AE.IAbstractGeometricAggregateType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiGeometryType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "MultiGeometryType";
			Init();
		}
		public MultiGeometryType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiGeometryType newObject = new AE.MultiGeometryType(_elementName);
			newObject.m_Id = m_Id;
