...
{
	/// <summary>
	/// 	This class represents the Element multiCurveDomain
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"multiCurveDomain", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class MultiCurveDomain : CSW.XmlCommonBase
					, AE.IDomainSetType
	{
		#region Constructors
		/// <summary>
		///		Constructor for MultiCurveDomain
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "multiCurveDomain";
			Init();
		}
		public MultiCurveDomain(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.MultiCurveDomain newObject = new AE.MultiCurveDomain(_elementName);
