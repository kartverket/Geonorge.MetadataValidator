...
{
	/// <summary>
	/// 	This class represents the Element includesCRS_Group
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"includesCRS_Group", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class IncludesCRS_Group : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for IncludesCRS_Group
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public IncludesCRS_Group()
		{
			_elementName = "includesCRS_Group";
			Init();
		}
		public IncludesCRS_Group(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.IncludesCRS_Group newObject = new AE.IncludesCRS_Group(_elementName);
