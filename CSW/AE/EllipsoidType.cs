...
{
	/// <summary>
	/// 	This class represents the ComplexType EllipsoidType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"EllipsoidType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class EllipsoidType : CSW.XmlCommonBase
					, AE.IEllipsoidBaseType
	{
		#region Constructors
		/// <summary>
		///		Constructor for EllipsoidType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "EllipsoidType";
			Init();
		}
		public EllipsoidType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_EllipsoidIDCol = new CSW.XmlObjectCollection<AE.EllipsoidID>("ellipsoidID", "http://www.opengis.net/gml", 0, -1, false);
			m_Remarks = null;
			m_SemiMajorAxis = null;
			m_SecondDefiningParameter = new AE.SecondDefiningParameter("secondDefiningParameter");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.EllipsoidType newObject = new AE.EllipsoidType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.EllipsoidID o in m_EllipsoidIDCol)
				newObject.m_EllipsoidIDCol.Add((AE.EllipsoidID)o.Clone());
			newObject.m_Remarks = null;
			if (m_Remarks != null)
				newObject.m_Remarks = (AE.Remarks)m_Remarks.Clone();
			newObject.m_SemiMajorAxis = null;
			if (m_SemiMajorAxis != null)
				newObject.m_SemiMajorAxis = (AE.IMeasureType)m_SemiMajorAxis.Clone();
			newObject.m_SecondDefiningParameter = null;
			if (m_SecondDefiningParameter != null)
				newObject.m_SecondDefiningParameter = (AE.SecondDefiningParameter)m_SecondDefiningParameter.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - ellipsoidID
		/// <summary>
		/// 	A collection of ellipsoidIDCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// 	<BR>This collection may contain 0 to Many objects.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("ellipsoidID", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.EllipsoidID> EllipsoidIDCol
		{
			get { return m_EllipsoidIDCol; }
		}
		protected CSW.XmlObjectCollection<AE.EllipsoidID> m_EllipsoidIDCol;
		...
		#region Attribute - semiMajorAxis
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqAbsClsMnd("semiMajorAxis", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.ClassFactory), "IMeasureTypeCreateObject")]
		public AE.IMeasureType SemiMajorAxis
		{
			get 
			{ 
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "semiMajorAxis");
				if (value != null)
				{
					// The object being set needs to take the element name from the class (the type="" attribute will then be set in the XML)
					SetElementName(value.GetBase(), "semiMajorAxis");
				}
				m_SemiMajorAxis = value; 
			}
		}
		protected AE.IMeasureType m_SemiMajorAxis;

		#endregion

		#region Attribute - secondDefiningParameter
		/// <summary>
		///		Represents a mandatory Element in the XML document
		/// 	
		/// </summary>
		...
		///		<BR>If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("secondDefiningParameter", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.SecondDefiningParameter), false)]
		public AE.SecondDefiningParameter SecondDefiningParameter
		{
			get 
			{ 
				return m_SecondDefiningParameter;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "secondDefiningParameter");
				m_SecondDefiningParameter = value;
			}
		}
		protected AE.SecondDefiningParameter m_SecondDefiningParameter;
