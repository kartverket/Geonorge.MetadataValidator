...
{
	/// <summary>
	/// 	This class represents the Element baseCurve
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"baseCurve", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class BaseCurve : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for BaseCurve
		/// </summary>
		/// <remarks>
		...
		public BaseCurve()
		{
			_elementName = "baseCurve";
			Init();
		}
		public BaseCurve(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.BaseCurve newObject = new AE.BaseCurve(_elementName);
			...
			newObject.m_BaseCurve_Group = null;
			if (m_BaseCurve_Group != null)
				newObject.m_BaseCurve_Group = (AE.BaseCurve_Group)m_BaseCurve_Group.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - baseCurve_Group
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("baseCurve_Group", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(AE.BaseCurve_Group))]
		public AE.BaseCurve_Group BaseCurve_Group
		{
			get 
			{ 
				return m_BaseCurve_Group;  
			}
			set 
			{ 
				if (value == null)
				...
				{
					m_BaseCurve_Group = value; 
				}
			}
		}
		protected AE.BaseCurve_Group m_BaseCurve_Group;
