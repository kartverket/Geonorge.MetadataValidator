...
{
	/// <summary>
	/// 	This class represents the Element absoluteExternalPositionalAccuracy
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"absoluteExternalPositionalAccuracy", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class AbsoluteExternalPositionalAccuracy : CSW.XmlCommonBase
					, AE.IAbstractPositionalAccuracyType
	{
		#region Constructors
		/// <summary>
		///		Constructor for AbsoluteExternalPositionalAccuracy
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "absoluteExternalPositionalAccuracy";
			Init();
		}
		public AbsoluteExternalPositionalAccuracy(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.AbsoluteExternalPositionalAccuracy newObject = new AE.AbsoluteExternalPositionalAccuracy(_elementName);
