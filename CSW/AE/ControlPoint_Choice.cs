...
{
	/// <summary>
	/// 	This class represents the Element controlPoint_Choice
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"controlPoint_Choice", "http://www.opengis.net/gml", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class ControlPoint_Choice : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for ControlPoint_Choice
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public ControlPoint_Choice()
		{
			_elementName = "controlPoint_Choice";
			Init();
		}
		public ControlPoint_Choice(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.ControlPoint_Choice newObject = new AE.ControlPoint_Choice(_elementName);
