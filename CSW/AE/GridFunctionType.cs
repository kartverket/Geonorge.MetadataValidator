...
{
	/// <summary>
	/// 	This class represents the ComplexType GridFunctionType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GridFunctionType", "http://www.opengis.net/gml", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GridFunctionType : CSW.XmlCommonBase
					, AE.IGridFunctionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GridFunctionType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "GridFunctionType";
			Init();
		}
		public GridFunctionType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.GridFunctionType newObject = new AE.GridFunctionType(_elementName);
