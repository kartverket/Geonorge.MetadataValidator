...
{
	/// <summary>
	/// 	This class represents the ComplexType StyleType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"StyleType", "http://www.opengis.net/gml", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class StyleType : CSW.XmlCommonBase
					, AE.IAbstractStyleType
	{
		#region Constructors
		/// <summary>
		///		Constructor for StyleType
		/// </summary>
		/// <remarks>
		...
		protected override void Init()
		{
			...
			m_FeatureStyleCol = new CSW.XmlObjectCollection<AE.FeatureStyle>("featureStyle", "http://www.opengis.net/gml", 1, -1, false);
			m_GraphStyle = null;
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AE.StyleType newObject = new AE.StyleType(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AE.FeatureStyle o in m_FeatureStyleCol)
				newObject.m_FeatureStyleCol.Add((AE.FeatureStyle)o.Clone());
			newObject.m_GraphStyle = null;
			if (m_GraphStyle != null)
				newObject.m_GraphStyle = (AE.GraphStyle)m_GraphStyle.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// <summary>
		/// 	A collection of featureStyleCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("featureStyle", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element)]
		public CSW.XmlObjectCollection<AE.FeatureStyle> FeatureStyleCol
		{
			get { return m_FeatureStyleCol; }
		}
		protected CSW.XmlObjectCollection<AE.FeatureStyle> m_FeatureStyleCol;
		...
		/// 	<BR>It is optional, initially it is null.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsOpt("graphStyle", "http://www.opengis.net/gml", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(AE.GraphStyle))]
		public AE.GraphStyle GraphStyle
		{
			get 
			{ 
				return m_GraphStyle;  
		...
		protected AE.GraphStyle m_GraphStyle;
