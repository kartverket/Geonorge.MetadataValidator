...
{
	/// <summary>
	/// 	This class represents the ComplexType BinaryComparisonOpType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"BinaryComparisonOpType", "http://www.opengis.net/ogc", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class BinaryComparisonOpType : CSW.XmlCommonBase
					, ogc.IComparisonOpsType
	{
		#region Constructors
		/// <summary>
		///		Constructor for BinaryComparisonOpType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "BinaryComparisonOpType";
			Init();
		}
		public BinaryComparisonOpType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ogc.BinaryComparisonOpType newObject = new ogc.BinaryComparisonOpType(_elementName);
