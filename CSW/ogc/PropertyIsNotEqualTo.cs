...
{
	/// <summary>
	/// 	This class represents the Element PropertyIsNotEqualTo
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PropertyIsNotEqualTo", "http://www.opengis.net/ogc", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PropertyIsNotEqualTo : CSW.XmlCommonBase
					, ogc.IComparisonOpsType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PropertyIsNotEqualTo
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PropertyIsNotEqualTo";
			Init();
		}
		public PropertyIsNotEqualTo(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ogc.PropertyIsNotEqualTo newObject = new ogc.PropertyIsNotEqualTo(_elementName);
