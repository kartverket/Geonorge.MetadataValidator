...
{
	/// <summary>
	/// 	This class represents the ComplexType DistanceBufferType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DistanceBufferType", "http://www.opengis.net/ogc", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DistanceBufferType : CSW.XmlCommonBase
					, ogc.ISpatialOpsType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DistanceBufferType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DistanceBufferType";
			Init();
		}
		public DistanceBufferType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ogc.DistanceBufferType newObject = new ogc.DistanceBufferType(_elementName);
