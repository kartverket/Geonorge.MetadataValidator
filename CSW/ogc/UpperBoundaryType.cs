...
{
	/// <summary>
	/// 	This class represents the ComplexType UpperBoundaryType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"UpperBoundaryType", "http://www.opengis.net/ogc", true, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class UpperBoundaryType : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for UpperBoundaryType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "UpperBoundaryType";
			Init();
		}
		public UpperBoundaryType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ogc.UpperBoundaryType newObject = new ogc.UpperBoundaryType(_elementName);
