...
{
	/// <summary>
	/// 	This class represents the Element PropertyIsLessThanOrEqualTo
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PropertyIsLessThanOrEqualTo", "http://www.opengis.net/ogc", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PropertyIsLessThanOrEqualTo : CSW.XmlCommonBase
					, ogc.IComparisonOpsType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PropertyIsLessThanOrEqualTo
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PropertyIsLessThanOrEqualTo";
			Init();
		}
		public PropertyIsLessThanOrEqualTo(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ogc.PropertyIsLessThanOrEqualTo newObject = new ogc.PropertyIsLessThanOrEqualTo(_elementName);
