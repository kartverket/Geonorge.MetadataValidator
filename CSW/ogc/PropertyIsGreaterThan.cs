...
{
	/// <summary>
	/// 	This class represents the Element PropertyIsGreaterThan
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PropertyIsGreaterThan", "http://www.opengis.net/ogc", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PropertyIsGreaterThan : CSW.XmlCommonBase
					, ogc.IComparisonOpsType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PropertyIsGreaterThan
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PropertyIsGreaterThan";
			Init();
		}
		public PropertyIsGreaterThan(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ogc.PropertyIsGreaterThan newObject = new ogc.PropertyIsGreaterThan(_elementName);
