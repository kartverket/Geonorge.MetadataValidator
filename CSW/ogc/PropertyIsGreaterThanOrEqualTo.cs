...
{
	/// <summary>
	/// 	This class represents the Element PropertyIsGreaterThanOrEqualTo
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PropertyIsGreaterThanOrEqualTo", "http://www.opengis.net/ogc", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PropertyIsGreaterThanOrEqualTo : CSW.XmlCommonBase
					, ogc.IComparisonOpsType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PropertyIsGreaterThanOrEqualTo
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PropertyIsGreaterThanOrEqualTo";
			Init();
		}
		public PropertyIsGreaterThanOrEqualTo(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ogc.PropertyIsGreaterThanOrEqualTo newObject = new ogc.PropertyIsGreaterThanOrEqualTo(_elementName);
