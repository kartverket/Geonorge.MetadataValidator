...
{
	/// <summary>
	/// 	This class represents the ComplexType PropertyIsNullType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"PropertyIsNullType", "http://www.opengis.net/ogc", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class PropertyIsNullType : CSW.XmlCommonBase
					, ogc.IComparisonOpsType
	{
		#region Constructors
		/// <summary>
		///		Constructor for PropertyIsNullType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "PropertyIsNullType";
			Init();
		}
		public PropertyIsNullType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ogc.PropertyIsNullType newObject = new ogc.PropertyIsNullType(_elementName);
