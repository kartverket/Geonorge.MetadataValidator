...
{
	/// <summary>
	/// 	This class represents the ComplexType BinaryOperatorType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"BinaryOperatorType", "http://www.opengis.net/ogc", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class BinaryOperatorType : CSW.XmlCommonBase
					, ogc.IExpressionType
	{
		#region Constructors
		/// <summary>
		///		Constructor for BinaryOperatorType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "BinaryOperatorType";
			Init();
		}
		public BinaryOperatorType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ogc.BinaryOperatorType newObject = new ogc.BinaryOperatorType(_elementName);
