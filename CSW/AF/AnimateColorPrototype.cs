...
{
	/// <summary>
	/// 	This class represents the ComplexType animateColorPrototype
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"animateColorPrototype", "http://www.w3.org/2001/SMIL20/", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class AnimateColorPrototype : CSW.XmlCommonBase
					, AF.IanimateColorPrototype
	{
		#region Constructors
		/// <summary>
		///		Constructor for AnimateColorPrototype
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "animateColorPrototype";
			Init();
		}
		public AnimateColorPrototype(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AF.AnimateColorPrototype newObject = new AF.AnimateColorPrototype(_elementName);
