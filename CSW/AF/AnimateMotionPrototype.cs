...
{
	/// <summary>
	/// 	This class represents the ComplexType animateMotionPrototype
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"animateMotionPrototype", "http://www.w3.org/2001/SMIL20/", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class AnimateMotionPrototype : CSW.XmlCommonBase
					, AF.IanimateMotionPrototype
	{
		#region Constructors
		/// <summary>
		///		Constructor for AnimateMotionPrototype
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "animateMotionPrototype";
			Init();
		}
		public AnimateMotionPrototype(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AF.AnimateMotionPrototype newObject = new AF.AnimateMotionPrototype(_elementName);
