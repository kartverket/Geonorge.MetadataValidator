...
{
	/// <summary>
	/// 	This class represents the ComplexType animateType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"animateType", "http://www.w3.org/2001/SMIL20/Language", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class AnimateType : CSW.XmlCommonBase
					, AG.IanimateType
					, AF.IanimatePrototype
	{
		#region Constructors
		/// <summary>
		///		Constructor for AnimateType
		/// </summary>
		/// <remarks>
		...
		public AnimateType()
		{
			_elementName = "animateType";
			Init();
		}
		public AnimateType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_AttributeName = "";
			m_AttributeType = CSW.Enumerations.IanimatePrototype_AttributeType.Auto;
			m_IsValidAttributeType = true;
			m_Additive = CSW.Enumerations.IanimatePrototype_Additive.Replace;
			m_IsValidAdditive = true;
			m_Accumulate = CSW.Enumerations.IanimatePrototype_Accumulate.None;
			...
			m_AnimateTypeDataCol = new CSW.XmlObjectCollection<AG.AnimateType_Type>("animateTypeData", "http://www.w3.org/2001/SMIL20/Language", 0, -1, true);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AG.AnimateType newObject = new AG.AnimateType(_elementName);
			...
			foreach (AG.AnimateType_Type o in m_AnimateTypeDataCol)
				newObject.m_AnimateTypeDataCol.Add((AG.AnimateType_Type)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.AttributeInfoEnum("attributeType", "", "IsValidAttributeType", typeof(CSW.Enumerations), "IanimatePrototype_AttributeTypeFromString", "IanimatePrototype_AttributeTypeToString", "auto")]
		public CSW.Enumerations.IanimatePrototype_AttributeType AttributeType
		{
			get 
			{ 
		...
		///		default value (CSW.Enumerations.IanimatePrototype_AttributeType.Auto).</BR>
		...
		public Boolean IsValidAttributeType
		{
			...
			{ 
				...
				{
					AttributeType = CSW.Enumerations.IanimatePrototype_AttributeType.Auto;
					m_IsValidAttributeType = value;
				}
			}
		}
		protected CSW.Enumerations.IanimatePrototype_AttributeType m_AttributeType;
		...
		/// 	<BR>It is optional, initially it is not valid.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.AttributeInfoEnum("additive", "", "IsValidAdditive", typeof(CSW.Enumerations), "IanimatePrototype_AdditiveFromString", "IanimatePrototype_AdditiveToString", "replace")]
		public CSW.Enumerations.IanimatePrototype_Additive Additive
		{
			get 
			{ 
		...
		///		<BR>If this is set to true then the property is considered valid, and assigned its
		///		default value (CSW.Enumerations.IanimatePrototype_Additive.Replace).</BR>
		...
		public Boolean IsValidAdditive
		{
			...
			{ 
				...
				{
					Additive = CSW.Enumerations.IanimatePrototype_Additive.Replace;
					m_IsValidAdditive = value;
				}
			}
		}
		protected CSW.Enumerations.IanimatePrototype_Additive m_Additive;
		...
		/// 	<BR>It is optional, initially it is not valid.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.AttributeInfoEnum("accumulate", "", "IsValidAccumulate", typeof(CSW.Enumerations), "IanimatePrototype_AccumulateFromString", "IanimatePrototype_AccumulateToString", "none")]
		public CSW.Enumerations.IanimatePrototype_Accumulate Accumulate
		{
			get 
			{ 
		...
		///		<BR>If this is set to true then the property is considered valid, and assigned its
		///		default value (CSW.Enumerations.IanimatePrototype_Accumulate.None).</BR>
		...
		public Boolean IsValidAccumulate
		{
			...
			{ 
				...
				{
					Accumulate = CSW.Enumerations.IanimatePrototype_Accumulate.None;
					m_IsValidAccumulate = value;
				}
			}
		}
		protected CSW.Enumerations.IanimatePrototype_Accumulate m_Accumulate;
		...
		#region Attribute - animateTypeData
		/// <summary>
		/// 	A collection of animateTypeDataCols
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("animateTypeData", "http://www.w3.org/2001/SMIL20/Language", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement)]
		public CSW.XmlObjectCollection<AG.AnimateType_Type> AnimateTypeDataCol
		{
			get { return m_AnimateTypeDataCol; }
		}
		protected CSW.XmlObjectCollection<AG.AnimateType_Type> m_AnimateTypeDataCol;
