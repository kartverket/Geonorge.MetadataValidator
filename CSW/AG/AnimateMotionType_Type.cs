...
{
	/// <summary>
	/// 	This class represents the Element animateMotionType_Type
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"animateMotionType_Type", "http://www.w3.org/2001/SMIL20/Language", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class AnimateMotionType_Type : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for AnimateMotionType_Type
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public AnimateMotionType_Type()
		{
			_elementName = "animateMotionType_Type";
			Init();
		}
		public AnimateMotionType_Type(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_CalcMode = CSW.Enumerations.AnimateMotionType_Type_CalcMode.Linear;
			m_IsValidCalcMode = true;
			...
			m_AnimateMotionType_Type_GroupCol = new CSW.XmlObjectCollection<AG.AnimateMotionType_Type_Group>("animateMotionType_Type_Group", "http://www.w3.org/2001/SMIL20/Language", 0, -1, true);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AG.AnimateMotionType_Type newObject = new AG.AnimateMotionType_Type(_elementName);
			newObject.m_Id = m_Id;
			...
			newObject.m_CalcMode = m_CalcMode;
			newObject.m_IsValidCalcMode = m_IsValidCalcMode;
			newObject.m_Skip_content = m_Skip_content;
			newObject.m_IsValidSkip_content = m_IsValidSkip_content;
			foreach (AG.AnimateMotionType_Type_Group o in m_AnimateMotionType_Type_GroupCol)
				newObject.m_AnimateMotionType_Type_GroupCol.Add((AG.AnimateMotionType_Type_Group)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// 	<BR>It is optional, initially it is not valid.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.AttributeInfoEnum("calcMode", "", "IsValidCalcMode", typeof(CSW.Enumerations), "AnimateMotionType_Type_CalcModeFromString", "AnimateMotionType_Type_CalcModeToString", "linear")]
		public CSW.Enumerations.AnimateMotionType_Type_CalcMode CalcMode
		{
			get 
			{ 
				if (m_IsValidCalcMode == false)
					throw new LiquidTechnologies.Runtime.Net45.LtInvalidStateException("The Property calcMode is not valid. Set calcModeValid = true");
				return m_CalcMode;  
			}
			set 
			{ 
		...
		/// <summary>
		/// 	Indicates if calcMode contains a valid value.
		/// </summary>
		/// <remarks>
		/// 	<BR>true if the value for calcMode is valid, false if not.</BR>
		///		<BR>If this is set to true then the property is considered valid, and assigned its
		///		default value (CSW.Enumerations.AnimateMotionType_Type_CalcMode.Linear).</BR>
		///		<BR>If its set to false then its made invalid, and subsequent calls to get calcMode
		///		will raise an exception.</BR>
		/// </remarks>
		public Boolean IsValidCalcMode
		{
			get { return m_IsValidCalcMode;  }
			set 
			{ 
				if (value != m_IsValidCalcMode)
				{
					CalcMode = CSW.Enumerations.AnimateMotionType_Type_CalcMode.Linear;
					m_IsValidCalcMode = value;
				}
			}
		}
		protected CSW.Enumerations.AnimateMotionType_Type_CalcMode m_CalcMode;
		protected Boolean m_IsValidCalcMode;
		...
		#region Attribute - animateMotionType_Type_Group
		/// <summary>
		/// 	A collection of animateMotionType_Type_GroupCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("animateMotionType_Type_Group", "http://www.w3.org/2001/SMIL20/Language", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement)]
		public CSW.XmlObjectCollection<AG.AnimateMotionType_Type_Group> AnimateMotionType_Type_GroupCol
		{
			get { return m_AnimateMotionType_Type_GroupCol; }
		}
		protected CSW.XmlObjectCollection<AG.AnimateMotionType_Type_Group> m_AnimateMotionType_Type_GroupCol;
