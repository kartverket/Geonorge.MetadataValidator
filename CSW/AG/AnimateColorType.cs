...
{
	/// <summary>
	/// 	This class represents the ComplexType animateColorType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"animateColorType", "http://www.w3.org/2001/SMIL20/Language", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class AnimateColorType : CSW.XmlCommonBase
					, AG.IanimateColorType
					, AF.IanimateColorPrototype
	{
		#region Constructors
		/// <summary>
		///		Constructor for AnimateColorType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "animateColorType";
			Init();
		}
		public AnimateColorType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AG.AnimateColorType newObject = new AG.AnimateColorType(_elementName);
