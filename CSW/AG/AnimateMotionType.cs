...
{
	/// <summary>
	/// 	This class represents the ComplexType animateMotionType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"animateMotionType", "http://www.w3.org/2001/SMIL20/Language", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class AnimateMotionType : CSW.XmlCommonBase
					, AG.IanimateMotionType
					, AF.IanimateMotionPrototype
	{
		#region Constructors
		/// <summary>
		///		Constructor for AnimateMotionType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "animateMotionType";
			Init();
		}
		public AnimateMotionType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AG.AnimateMotionType newObject = new AG.AnimateMotionType(_elementName);
