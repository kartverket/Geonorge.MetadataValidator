...
{
	/// <summary>
	/// 	This class represents the Element animateType_Type
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"animateType_Type", "http://www.w3.org/2001/SMIL20/Language", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class AnimateType_Type : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for AnimateType_Type
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public AnimateType_Type()
		{
			_elementName = "animateType_Type";
			Init();
		}
		public AnimateType_Type(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_CalcMode = CSW.Enumerations.AnimateType_Type_CalcMode.Linear;
			...
			m_AnimateType_Type_GroupCol = new CSW.XmlObjectCollection<AG.AnimateType_Type_Group>("animateType_Type_Group", "http://www.w3.org/2001/SMIL20/Language", 0, -1, true);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AG.AnimateType_Type newObject = new AG.AnimateType_Type(_elementName);
			newObject.m_Id = m_Id;
			...
			foreach (AG.AnimateType_Type_Group o in m_AnimateType_Type_GroupCol)
				newObject.m_AnimateType_Type_GroupCol.Add((AG.AnimateType_Type_Group)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// 	<BR>It is optional, initially it is not valid.</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.AttributeInfoEnum("calcMode", "", "IsValidCalcMode", typeof(CSW.Enumerations), "AnimateType_Type_CalcModeFromString", "AnimateType_Type_CalcModeToString", "linear")]
		public CSW.Enumerations.AnimateType_Type_CalcMode CalcMode
		{
			get 
			{ 
		...
		///		<BR>If this is set to true then the property is considered valid, and assigned its
		///		default value (CSW.Enumerations.AnimateType_Type_CalcMode.Linear).</BR>
		...
		public Boolean IsValidCalcMode
		{
			...
			{ 
				...
				{
					CalcMode = CSW.Enumerations.AnimateType_Type_CalcMode.Linear;
					m_IsValidCalcMode = value;
				}
			}
		}
		protected CSW.Enumerations.AnimateType_Type_CalcMode m_CalcMode;
		...
		#region Attribute - animateType_Type_Group
		/// <summary>
		/// 	A collection of animateType_Type_GroupCols
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsCol("animateType_Type_Group", "http://www.w3.org/2001/SMIL20/Language", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement)]
		public CSW.XmlObjectCollection<AG.AnimateType_Type_Group> AnimateType_Type_GroupCol
		{
			get { return m_AnimateType_Type_GroupCol; }
		}
		protected CSW.XmlObjectCollection<AG.AnimateType_Type_Group> m_AnimateType_Type_GroupCol;
