...
{
	/// <summary>
	/// 	This class represents the Element GetCapabilities
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GetCapabilities", "http://www.opengis.net/cat/csw/2.0.2", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GetCapabilities : CSW.XmlCommonBase
					, ows.IGetCapabilitiesType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GetCapabilities
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "GetCapabilities";
			Init();
		}
		public GetCapabilities(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			csw.GetCapabilities newObject = new csw.GetCapabilities(_elementName);
