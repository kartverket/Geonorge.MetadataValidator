...
{
	/// <summary>
	/// 	This class represents the Element DCMIRecord
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DCMIRecord", "http://www.opengis.net/cat/csw/2.0.2", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DCMIRecord : CSW.XmlCommonBase
					, csw.IAbstractRecordType
					, csw.IDCMIRecordType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DCMIRecord
		/// </summary>
		/// <remarks>
		...
		public DCMIRecord()
		{
			_elementName = "DCMIRecord";
			Init();
		}
		public DCMIRecord(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			csw.DCMIRecord newObject = new csw.DCMIRecord(_elementName);
