...
{
	/// <summary>
	/// 	This class represents the Element GetDomainType_Type
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Choice,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement,
													"GetDomainType_Type", "http://www.opengis.net/cat/csw/2.0.2", false, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GetDomainType_Type : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for GetDomainType_Type
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public GetDomainType_Type()
		{
			_elementName = "GetDomainType_Type";
			Init();
		}
		public GetDomainType_Type(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			csw.GetDomainType_Type newObject = new csw.GetDomainType_Type(_elementName);
