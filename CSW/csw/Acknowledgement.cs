...
{
	/// <summary>
	/// 	This class represents the Element Acknowledgement
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"Acknowledgement", "http://www.opengis.net/cat/csw/2.0.2", true, false,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class Acknowledgement : CSW.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for Acknowledgement
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "Acknowledgement";
			Init();
		}
		public Acknowledgement(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_EchoedRequest = new csw.EchoedRequestType("EchoedRequest");
			m_RequestId = "";
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			csw.Acknowledgement newObject = new csw.Acknowledgement(_elementName);
			newObject.m_TimeStamp = (LiquidTechnologies.Runtime.Net45.XmlDateTime)m_TimeStamp.Clone();
			newObject.m_EchoedRequest = null;
			if (m_EchoedRequest != null)
				newObject.m_EchoedRequest = (csw.EchoedRequestType)m_EchoedRequest.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		///		<BR>It is defaulted to new LiquidTechnologies.Runtime.Net45.XmlDateTime(LiquidTechnologies.Runtime.Net45.XmlDateTime.DateType.dateTime).</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.AttributeInfoPrimitive("timeStamp", "", LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_datetime, null, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Collapse, null, "", -1, -1, "", "", "", "", -1)]
		...
		#region Attribute - EchoedRequest
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("EchoedRequest", "http://www.opengis.net/cat/csw/2.0.2", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, typeof(csw.EchoedRequestType), false)]
		public csw.EchoedRequestType EchoedRequest
		{
			get 
			{ 
				return m_EchoedRequest;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "EchoedRequest");
				if (value != null)
					SetElementName(value, "EchoedRequest");
				m_EchoedRequest = value;
			}
		}
		protected csw.EchoedRequestType m_EchoedRequest;
