...
{
	/// <summary>
	/// 	This class represents the ComplexType GetDomainType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"GetDomainType", "http://www.opengis.net/cat/csw/2.0.2", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class GetDomainType : CSW.XmlCommonBase
					, csw.IRequestBaseType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GetDomainType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "GetDomainType";
			Init();
		}
		public GetDomainType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_GetDomainTypeData = new csw.GetDomainType_Type("GetDomainTypeData");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			csw.GetDomainType newObject = new csw.GetDomainType(_elementName);
			newObject.m_Service = m_Service;
			newObject.m_Version = m_Version;
			newObject.m_GetDomainTypeData = null;
			if (m_GetDomainTypeData != null)
				newObject.m_GetDomainTypeData = (csw.GetDomainType_Type)m_GetDomainTypeData.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - GetDomainTypeData
		/// <summary>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net45.ElementInfoSeqClsMnd("GetDomainTypeData", "http://www.opengis.net/cat/csw/2.0.2", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.PseudoElement, typeof(csw.GetDomainType_Type), false)]
		public csw.GetDomainType_Type GetDomainTypeData
		{
			get 
			{ 
				return m_GetDomainTypeData;  
			}
			set 
			{ 
				Throw_IfPropertyIsNull(value, "GetDomainTypeData");
				m_GetDomainTypeData = value;
			}
		}
		protected csw.GetDomainType_Type m_GetDomainTypeData;
