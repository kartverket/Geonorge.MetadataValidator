...
{
	/// <summary>
	/// 	This class represents the ComplexType DCMIRecordType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"DCMIRecordType", "http://www.opengis.net/cat/csw/2.0.2", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class DCMIRecordType : CSW.XmlCommonBase
					, csw.IDCMIRecordType
					, csw.IAbstractRecordType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DCMIRecordType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "DCMIRecordType";
			Init();
		}
		public DCMIRecordType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			csw.DCMIRecordType newObject = new csw.DCMIRecordType(_elementName);
