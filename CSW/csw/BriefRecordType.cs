...
{
	/// <summary>
	/// 	This class represents the ComplexType BriefRecordType
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"BriefRecordType", "http://www.opengis.net/cat/csw/2.0.2", false, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, null, false)]
	public partial class BriefRecordType : CSW.XmlCommonBase
					, csw.IAbstractRecordType
	{
		#region Constructors
		/// <summary>
		///		Constructor for BriefRecordType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "BriefRecordType";
			Init();
		}
		public BriefRecordType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			csw.BriefRecordType newObject = new csw.BriefRecordType(_elementName);
