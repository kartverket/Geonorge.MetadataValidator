...
{
	/// <summary>
	/// 	This class represents the ComplexType SimpleLiteral
	/// </summary>
	[LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element,
													"SimpleLiteral", "http://purl.org/dc/elements/1.1/", true, true,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, null, false)]
	public partial class SimpleLiteral : CSW.XmlCommonBase
					, AA.ISimpleLiteral
	{
		#region Constructors
		/// <summary>
		///		Constructor for SimpleLiteral
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "SimpleLiteral";
			Init();
		}
		public SimpleLiteral(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			AA.SimpleLiteral newObject = new AA.SimpleLiteral(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element SimpleLiteral, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;SimpleLiteral&gt;Some Data&lt;/SimpleLiteral&gt;</BR>
		/// </remarks>
